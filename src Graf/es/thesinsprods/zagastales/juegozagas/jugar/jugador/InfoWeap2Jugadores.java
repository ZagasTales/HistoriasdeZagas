...
public class InfoWeap2Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getWeapon2().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getWeapon2().getPossesion().getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(VentanaJugadores.class
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap2Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField_3.setText(VentanaJugadores.personaje.getWeapon2().getTipo());
		frame.getContentPane().add(textField_3);
		if (VentanaJugadores.personaje.getWeapon2().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (VentanaJugadores.personaje.getWeapon2().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (VentanaJugadores.personaje.getWeapon2().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (VentanaJugadores.personaje.getWeapon2().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (VentanaJugadores.personaje.getWeapon2().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!VentanaJugadores.personaje.getWeapon2().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getWeapon2().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getWeapon2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getWeapon2().isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap2Jugadores.class
