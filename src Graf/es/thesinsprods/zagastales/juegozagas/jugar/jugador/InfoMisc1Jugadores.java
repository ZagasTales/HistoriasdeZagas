...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getMisc1().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getMisc1().getPossesion().getPos();
		...
		textField.setText(VentanaJugadores.personaje.getMisc1().getMisc());
		if(!VentanaJugadores.personaje.getMisc1().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getMisc1().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getMisc1().isLegendaria() == true) {
