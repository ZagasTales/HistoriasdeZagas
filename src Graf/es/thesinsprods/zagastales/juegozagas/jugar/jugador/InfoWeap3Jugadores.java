...
public class InfoWeap3Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getWeapon3().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getWeapon3().getPossesion().getPos();
		...
		textField_3.setText(VentanaJugadores.personaje.getWeapon3().getTipo());
		frame.getContentPane().add(textField_3);
		if (VentanaJugadores.personaje.getWeapon3().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (VentanaJugadores.personaje.getWeapon3().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (VentanaJugadores.personaje.getWeapon3().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (VentanaJugadores.personaje.getWeapon3().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (VentanaJugadores.personaje.getWeapon3().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!VentanaJugadores.personaje.getWeapon3().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getWeapon3().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getWeapon3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getWeapon3().isLegendaria() == true) {
