...
public class InfoWeap1Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getWeapon1().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getWeapon1().getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap1Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField_3.setText(VentanaJugadores.personaje.getWeapon1().getTipo());
		frame.getContentPane().add(textField_3);
		if (VentanaJugadores.personaje.getWeapon1().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (VentanaJugadores.personaje.getWeapon1().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (VentanaJugadores.personaje.getWeapon1().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (VentanaJugadores.personaje.getWeapon1().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (VentanaJugadores.personaje.getWeapon1().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!VentanaJugadores.personaje.getWeapon1().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getWeapon1().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getWeapon1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getWeapon1().isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap1Jugadores.class
