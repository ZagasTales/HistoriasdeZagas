...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getArmor().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getArmor().getPossesion().getPos();
		...
		if(!VentanaJugadores.personaje.getArmor().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getArmor().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (VentanaJugadores.personaje.getArmor().isLegendaria() == true) {
