...
public class DestrezasJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+VentanaJugadores.personaje.getKnowhowSkills().getAthletics());
		...
		textField_1.setText(""+VentanaJugadores.personaje.getKnowhowSkills().getSurvival());
		...
		textField_2.setText(""+VentanaJugadores.personaje.getKnowhowSkills().getEquitation());
		...
		textField_3.setText(""+VentanaJugadores.personaje.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""+VentanaJugadores.personaje.getKnowhowSkills().getStealth());
