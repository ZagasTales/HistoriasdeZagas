...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+VentanaJugadores.personaje.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+VentanaJugadores.personaje.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+VentanaJugadores.personaje.getCombatSkills().getPole());
		...
		textField_3.setText(""+VentanaJugadores.personaje.getCombatSkills().getRanged());
		...
		textField_4.setText(""+VentanaJugadores.personaje.getCombatSkills().getDodge());
		...
		textField_5.setText(""+VentanaJugadores.personaje.getCombatSkills().getBlock());
