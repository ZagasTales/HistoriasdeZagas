...
public class InfoAcc1Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getAcc1().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getAcc1().getPossesion().getPos();
		...
		if (VentanaJugadores.personaje.getAcc1().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (VentanaJugadores.personaje.getAcc1().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (VentanaJugadores.personaje.getAcc1().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (VentanaJugadores.personaje.getAcc1().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		if(!VentanaJugadores.personaje.getAcc1().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getAcc1().getDescription());}
		...
		if (VentanaJugadores.personaje.getAcc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getAcc1().isLegendaria() == true) {
