...
public class InfoAcc3Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getAcc3().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getAcc3().getPossesion().getPos();
		...
		if (VentanaJugadores.personaje.getAcc3().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (VentanaJugadores.personaje.getAcc3().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (VentanaJugadores.personaje.getAcc3().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (VentanaJugadores.personaje.getAcc3().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}
		if(!VentanaJugadores.personaje.getAcc3().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getAcc3().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getAcc3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getAcc3().isLegendaria() == true) {
