...
public class ConocimientosJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getArtofWar());
		...
		textField_1.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getDiplomacy());
		...
		textField_2.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getEtiquette());
		...
		textField_3.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getMedicine());
		...
		textField_4.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getOccultism());
		...
		textField_5.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getResearch());
		...
		textField_6.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getNegotiation());
		...
		textField_7.setText(""+VentanaJugadores.personaje.getKnowledgeSkills().getSecretKnowledge());
