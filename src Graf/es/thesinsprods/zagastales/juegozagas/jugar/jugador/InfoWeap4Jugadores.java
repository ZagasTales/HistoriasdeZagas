...
public class InfoWeap4Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getWeapon4().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getWeapon4().getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap4Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField_3.setText(VentanaJugadores.personaje.getWeapon4().getTipo());
		frame.getContentPane().add(textField_3);
		if (VentanaJugadores.personaje.getWeapon4().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (VentanaJugadores.personaje.getWeapon4().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (VentanaJugadores.personaje.getWeapon4().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (VentanaJugadores.personaje.getWeapon4().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (VentanaJugadores.personaje.getWeapon4().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!VentanaJugadores.personaje.getWeapon4().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getWeapon4().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getWeapon4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getWeapon4().isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap4Jugadores.class
