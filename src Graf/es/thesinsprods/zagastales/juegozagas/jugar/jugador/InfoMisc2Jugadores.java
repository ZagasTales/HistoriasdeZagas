...
public class InfoMisc2Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getMisc2().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getMisc2().getPossesion().getPos();
		...
		textField.setText(VentanaJugadores.personaje.getMisc2().getMisc());
		if(!VentanaJugadores.personaje.getMisc2().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getMisc2().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getMisc2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getMisc2().isLegendaria() == true) {
