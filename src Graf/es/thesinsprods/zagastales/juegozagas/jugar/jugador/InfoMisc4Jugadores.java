...
public class InfoMisc4Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getMisc4().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getMisc4().getPossesion().getPos();
		...
		textField.setText(VentanaJugadores.personaje.getMisc4().getMisc());
		if(!VentanaJugadores.personaje.getMisc4().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getMisc4().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getMisc4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getMisc4().isLegendaria() == true) {
