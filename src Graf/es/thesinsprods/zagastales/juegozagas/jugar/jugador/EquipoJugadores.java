...
public class EquipoJugadores {
	...
	private void initialize() {
		...
		if(!VentanaJugadores.personaje.getArmor().getArmor().equals("")){
			if(!VentanaJugadores.personaje.getArmor().getArmor().equals("null")){
		textField.setText(VentanaJugadores.personaje.getArmor().getArmor());
		...
		if(!VentanaJugadores.personaje.getWeapon1().getWeapon().equals("")){
			if(!VentanaJugadores.personaje.getWeapon1().getWeapon().equals("null")){
		textField_1.setText(VentanaJugadores.personaje.getWeapon1().getWeapon());
		...
		if(!VentanaJugadores.personaje.getWeapon2().getWeapon().equals("")){
			if(!VentanaJugadores.personaje.getWeapon2().getWeapon().equals("null")){
		textField_2.setText(VentanaJugadores.personaje.getWeapon2().getWeapon());
		...
		if(!VentanaJugadores.personaje.getWeapon3().getWeapon().equals("") ){
			if(!VentanaJugadores.personaje.getWeapon3().getWeapon().equals("null")){
		textField_3.setText(VentanaJugadores.personaje.getWeapon3().getWeapon());
		...
		if(!VentanaJugadores.personaje.getWeapon4().getWeapon().equals("")){
			if(!VentanaJugadores.personaje.getWeapon4().getWeapon().equals("null")){
		textField_4.setText(VentanaJugadores.personaje.getWeapon4().getWeapon());
		...
		if(!VentanaJugadores.personaje.getAcc1().getAccesory().equals("")){
			if(!VentanaJugadores.personaje.getAcc1().getAccesory().equals("null")){
		textField_5.setText(VentanaJugadores.personaje.getAcc1().getAccesory());
		...
		if(!VentanaJugadores.personaje.getAcc2().getAccesory().equals("")){
			if(!VentanaJugadores.personaje.getAcc2().getAccesory().equals("null")){
		textField_6.setText(VentanaJugadores.personaje.getAcc2().getAccesory());
		...
		if(!VentanaJugadores.personaje.getAcc3().getAccesory().equals("")){
			if(!VentanaJugadores.personaje.getAcc3().getAccesory().equals("null")){
		textField_7.setText(VentanaJugadores.personaje.getAcc3().getAccesory());
		...
		if(!VentanaJugadores.personaje.getAcc4().getAccesory().equals("")){
			if(!VentanaJugadores.personaje.getAcc4().getAccesory().equals("null")){
		textField_8.setText(VentanaJugadores.personaje.getAcc4().getAccesory());
		...
		if(!VentanaJugadores.personaje.getMisc1().getMisc().equals("")){
			if(!VentanaJugadores.personaje.getMisc1().getMisc().equals("null")){
		textField_9.setText(VentanaJugadores.personaje.getMisc1().getMisc());
		...
		if(!VentanaJugadores.personaje.getMisc2().getMisc().equals("")){
			if(!VentanaJugadores.personaje.getMisc2().getMisc().equals("null")){
		textField_10.setText(VentanaJugadores.personaje.getMisc2().getMisc());
		...
		if(!VentanaJugadores.personaje.getMisc3().getMisc().equals("")){
			if(!VentanaJugadores.personaje.getMisc3().getMisc().equals("null")){
		textField_11.setText(VentanaJugadores.personaje.getMisc3().getMisc());
		...
		if(!VentanaJugadores.personaje.getMisc4().getMisc().equals("")){
			if(!VentanaJugadores.personaje.getMisc4().getMisc().equals("null")){
		textField_12.setText(VentanaJugadores.personaje.getMisc4().getMisc());
