...
public class InfoMisc3Jugadores {
	...
	private void initialize() {
		...
		if (VentanaJugadores.personaje.getMisc3().isPosesion() == true) {

			ArrayList<String> pos = VentanaJugadores.personaje.getMisc3().getPossesion().getPos();
		...
		textField.setText(VentanaJugadores.personaje.getMisc3().getMisc());
		if(!VentanaJugadores.personaje.getMisc3().getDescription().equals("null")){
		textArea.setText(VentanaJugadores.personaje.getMisc3().getDescription());
		}
		...
		if (VentanaJugadores.personaje.getMisc3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (VentanaJugadores.personaje.getMisc3().isLegendaria() == true) {
