...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje3.getPoderes());
		...
		textArea.setText(JugarOnline.personaje3.getExtras());
		...
		textArea.setText(JugarOnline.personaje3.getModificadores());
