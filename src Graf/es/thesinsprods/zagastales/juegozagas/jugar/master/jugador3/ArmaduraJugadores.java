...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje3.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje3.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje3.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje3.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje3.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje3.getArmor().isLegendaria() == true) {
