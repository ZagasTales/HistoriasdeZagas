...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje3.getMisc1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje3.getMisc1().getPossesion().getPos();
		...
		textField.setText(JugarOnline.personaje3.getMisc1().getMisc());
		if(!JugarOnline.personaje3.getMisc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje3.getMisc1().getDescription());
		}
		...
		if (JugarOnline.personaje3.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje3.getMisc1().isLegendaria() == true) {
