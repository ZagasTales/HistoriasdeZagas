...
public class CombateMele {
	...
	private void initialize() {
		...
		btnNewButton.setBounds(313, 330, 121, 50);
		...
		button.setIcon(new ImageIcon(CombateMele.class.getResource("/images/boton atras.png")));
