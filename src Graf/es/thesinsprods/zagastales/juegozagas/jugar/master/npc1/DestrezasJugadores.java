...
public class DestrezasJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc1.getKnowhowSkills().getAthletics());
		...
		textField_1.setText(""+JugarOnline.npc1.getKnowhowSkills().getSurvival());
		...
		textField_2.setText(""+JugarOnline.npc1.getKnowhowSkills().getEquitation());
		...
		textField_3.setText(""+JugarOnline.npc1.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""+JugarOnline.npc1.getKnowhowSkills().getStealth());
