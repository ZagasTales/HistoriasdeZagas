...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc1.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc1.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc1.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc1.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc1.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc1.getArmor().isLegendaria() == true) {
