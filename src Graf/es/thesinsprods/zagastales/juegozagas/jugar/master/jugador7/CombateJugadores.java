...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje7.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.personaje7.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.personaje7.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.personaje7.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.personaje7.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.personaje7.getCombatSkills().getBlock());
