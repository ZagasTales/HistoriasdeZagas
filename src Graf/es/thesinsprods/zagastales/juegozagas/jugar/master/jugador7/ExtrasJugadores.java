...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje7.getPoderes());
		...
		textArea.setText(JugarOnline.personaje7.getExtras());
		...
		textArea.setText(JugarOnline.personaje7.getModificadores());
