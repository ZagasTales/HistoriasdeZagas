...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje7.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.personaje7.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.personaje7.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.personaje7.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.personaje7.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.personaje7.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.personaje7.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.personaje7.getMagicSkills().getArcane());
