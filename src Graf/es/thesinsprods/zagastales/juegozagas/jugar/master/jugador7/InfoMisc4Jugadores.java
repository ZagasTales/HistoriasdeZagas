...
public class InfoMisc4Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje7.getMisc4().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje7.getMisc4().getPossesion().getPos();
		...
		textField.setText(JugarOnline.personaje7.getMisc4().getMisc());
		if(!JugarOnline.personaje7.getMisc4().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje7.getMisc4().getDescription());
		}
		...
		if (JugarOnline.personaje7.getMisc4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje7.getMisc4().isLegendaria() == true) {
