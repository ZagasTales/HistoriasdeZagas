...
public class InfoAcc4NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.accesories4.isPosesion() == true || ModificarEquipo.accesories4.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.accesories4.getPossesion()
					.getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(InfoAcc4NPC.class
		...
		if (ModificarEquipo.accesories4.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (ModificarEquipo.accesories4.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (ModificarEquipo.accesories4.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (ModificarEquipo.accesories4.getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		textArea.setText(ModificarEquipo.accesories4.getDescription());
		...
		if (ModificarEquipo.accesories4.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.accesories4.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.accesories4.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoAcc4NPC.class
