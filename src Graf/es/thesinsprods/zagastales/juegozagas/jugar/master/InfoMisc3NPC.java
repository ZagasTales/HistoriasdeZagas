...
public class InfoMisc3NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.misc3.isPosesion() == true ||ModificarEquipo.misc3.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.misc3.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc3NPC.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(ModificarEquipo.misc3.getMisc());
		textArea.setText(ModificarEquipo.misc3.getDescription());
		...
		if (ModificarEquipo.misc3.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.misc3.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.misc3.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc3NPC.class
