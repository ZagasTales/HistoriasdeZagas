...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje4.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje4.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje4.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje4.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje4.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje4.getArmor().isLegendaria() == true) {
