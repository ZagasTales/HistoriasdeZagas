...
public class InfoWeap4Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje4.getWeapon4().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje4.getWeapon4().getPossesion().getPos();
		...
		textField_3.setText(JugarOnline.personaje4.getWeapon4().getTipo());
		frame.getContentPane().add(textField_3);
		if (JugarOnline.personaje4.getWeapon4().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (JugarOnline.personaje4.getWeapon4().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (JugarOnline.personaje4.getWeapon4().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (JugarOnline.personaje4.getWeapon4().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (JugarOnline.personaje4.getWeapon4().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!JugarOnline.personaje4.getWeapon4().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje4.getWeapon4().getDescription());
		}
		...
		if (JugarOnline.personaje4.getWeapon4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje4.getWeapon4().isLegendaria() == true) {
