...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje4.getPoderes());
		...
		textArea.setText(JugarOnline.personaje4.getExtras());
		...
		textArea.setText(JugarOnline.personaje4.getModificadores());
