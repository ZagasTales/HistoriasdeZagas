...
public class InfoAcc1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje4.getAcc1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje4.getAcc1().getPossesion().getPos();
		...
		if (JugarOnline.personaje4.getAcc1().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (JugarOnline.personaje4.getAcc1().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (JugarOnline.personaje4.getAcc1().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (JugarOnline.personaje4.getAcc1().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		if(!JugarOnline.personaje4.getAcc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje4.getAcc1().getDescription());}
		...
		if (JugarOnline.personaje4.getAcc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje4.getAcc1().isLegendaria() == true) {
