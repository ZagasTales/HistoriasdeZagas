...
public class InfoArm1NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.armor1.isPosesion() == true ||ModificarEquipo.armor1.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.armor1.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoArm1NPC.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(ModificarEquipo.armor1.getArmor());
		textArea.setText(ModificarEquipo.armor1.getDescription());
		...
		if (ModificarEquipo.armor1.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.armor1.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.armor1.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoArm1NPC.class
