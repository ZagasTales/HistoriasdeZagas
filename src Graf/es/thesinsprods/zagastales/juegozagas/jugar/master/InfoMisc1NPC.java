...
public class InfoMisc1NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.misc1.isPosesion() == true ||ModificarEquipo.misc1.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.misc1.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc1NPC.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(ModificarEquipo.misc1.getMisc());
		textArea.setText(ModificarEquipo.misc1.getDescription());
		...
		if (ModificarEquipo.misc1.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.misc1.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.misc1.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc1NPC.class
