...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje2.getPoderes());
		...
		textArea.setText(JugarOnline.personaje2.getExtras());
		...
		textArea.setText(JugarOnline.personaje2.getModificadores());
