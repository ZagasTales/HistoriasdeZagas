...
public class InfoAcc2Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje2.getAcc2().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje2.getAcc2().getPossesion().getPos();
		...
		if (JugarOnline.personaje2.getAcc2().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (JugarOnline.personaje2.getAcc2().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (JugarOnline.personaje2.getAcc2().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (JugarOnline.personaje2.getAcc2().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}
		if(!JugarOnline.personaje2.getAcc2().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje2.getAcc2().getDescription());
		}
		...
		if (JugarOnline.personaje2.getAcc2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje2.getAcc2().isLegendaria() == true) {
