...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje2.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.personaje2.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.personaje2.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.personaje2.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.personaje2.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.personaje2.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.personaje2.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.personaje2.getMagicSkills().getArcane());
