...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje2.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje2.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje2.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje2.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje2.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje2.getArmor().isLegendaria() == true) {
