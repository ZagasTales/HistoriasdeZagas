...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc5.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc5.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc5.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc5.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc5.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc5.getArmor().isLegendaria() == true) {
