...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		textField.setText(JugarOnline.npc5.getMisc1().getMisc());
		if(!JugarOnline.npc5.getMisc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc5.getMisc1().getDescription());
		}
		...
		if (JugarOnline.npc5.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc5.getMisc1().isLegendaria() == true) {
