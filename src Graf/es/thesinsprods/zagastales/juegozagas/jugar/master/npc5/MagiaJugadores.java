...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc5.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.npc5.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.npc5.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.npc5.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.npc5.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.npc5.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.npc5.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.npc5.getMagicSkills().getArcane());
