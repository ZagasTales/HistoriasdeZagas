...
public class InfoMisc3Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje1.getMisc3().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje1.getMisc3().getPossesion().getPos();
		...
		textField.setText(JugarOnline.personaje1.getMisc3().getMisc());
		if(!JugarOnline.personaje1.getMisc3().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje1.getMisc3().getDescription());
		}
		...
		if (JugarOnline.personaje1.getMisc3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje1.getMisc3().isLegendaria() == true) {
