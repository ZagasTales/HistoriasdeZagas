package es.thesinsprods.zagastales.juegozagas.jugar.master.jugador1;
...
public class EquipoJugadores {
	...
	private void initialize() {
		...
		if(!JugarOnline.personaje1.getArmor().getArmor().equals("")){
			if(!JugarOnline.personaje1.getArmor().getArmor().equals("null")){
		textField.setText(JugarOnline.personaje1.getArmor().getArmor());
		...
		if(!JugarOnline.personaje1.getWeapon1().getWeapon().equals("")){
			if(!JugarOnline.personaje1.getWeapon1().getWeapon().equals("null")){
		textField_1.setText(JugarOnline.personaje1.getWeapon1().getWeapon());
		...
		if(!JugarOnline.personaje1.getWeapon2().getWeapon().equals("")){
			if(!JugarOnline.personaje1.getWeapon2().getWeapon().equals("null")){
		textField_2.setText(JugarOnline.personaje1.getWeapon2().getWeapon());
		...
		if(!JugarOnline.personaje1.getWeapon3().getWeapon().equals("") ){
			if(!JugarOnline.personaje1.getWeapon3().getWeapon().equals("null")){
		textField_3.setText(JugarOnline.personaje1.getWeapon3().getWeapon());
		...
		if(!JugarOnline.personaje1.getWeapon4().getWeapon().equals("")){
			if(!JugarOnline.personaje1.getWeapon4().getWeapon().equals("null")){
		textField_4.setText(JugarOnline.personaje1.getWeapon4().getWeapon());
		...
		if(!JugarOnline.personaje1.getAcc1().getAccesory().equals("")){
			if(!JugarOnline.personaje1.getAcc1().getAccesory().equals("null")){
		textField_5.setText(JugarOnline.personaje1.getAcc1().getAccesory());
		...
		if(!JugarOnline.personaje1.getAcc2().getAccesory().equals("")){
			if(!JugarOnline.personaje1.getAcc2().getAccesory().equals("null")){
		textField_6.setText(JugarOnline.personaje1.getAcc2().getAccesory());
		...
		if(!JugarOnline.personaje1.getAcc3().getAccesory().equals("")){
			if(!JugarOnline.personaje1.getAcc3().getAccesory().equals("null")){
		textField_7.setText(JugarOnline.personaje1.getAcc3().getAccesory());
		...
		if(!JugarOnline.personaje1.getAcc4().getAccesory().equals("")){
			if(!JugarOnline.personaje1.getAcc4().getAccesory().equals("null")){
		textField_8.setText(JugarOnline.personaje1.getAcc4().getAccesory());
		...
		if(!JugarOnline.personaje1.getMisc1().getMisc().equals("")){
			if(!JugarOnline.personaje1.getMisc1().getMisc().equals("null")){
		textField_9.setText(JugarOnline.personaje1.getMisc1().getMisc());
		...
		if(!JugarOnline.personaje1.getMisc2().getMisc().equals("")){
			if(!JugarOnline.personaje1.getMisc2().getMisc().equals("null")){
		textField_10.setText(JugarOnline.personaje1.getMisc2().getMisc());
		...
		if(!JugarOnline.personaje1.getMisc3().getMisc().equals("")){
			if(!JugarOnline.personaje1.getMisc3().getMisc().equals("null")){
		textField_11.setText(JugarOnline.personaje1.getMisc3().getMisc());
		...
		if(!JugarOnline.personaje1.getMisc4().getMisc().equals("")){
			if(!JugarOnline.personaje1.getMisc4().getMisc().equals("null")){
		textField_12.setText(JugarOnline.personaje1.getMisc4().getMisc());
