...
public class ConocimientosJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getArtofWar());
		...
		textField_1.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getDiplomacy());
		...
		textField_2.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getEtiquette());
		...
		textField_3.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getMedicine());
		...
		textField_4.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getOccultism());
		...
		textField_5.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getResearch());
		...
		textField_6.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getNegotiation());
		...
		textField_7.setText(""+JugarOnline.personaje1.getKnowledgeSkills().getSecretKnowledge());
