...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje1.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.personaje1.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.personaje1.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.personaje1.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.personaje1.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.personaje1.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.personaje1.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.personaje1.getMagicSkills().getArcane());
