...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje1.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje1.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje1.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje1.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje1.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje1.getArmor().isLegendaria() == true) {
