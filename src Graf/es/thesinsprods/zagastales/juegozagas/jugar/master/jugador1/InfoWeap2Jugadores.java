...
public class InfoWeap2Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje1.getWeapon2().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje1.getWeapon2().getPossesion().getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(Personaje1.class
		...
		textField_3.setText(JugarOnline.personaje1.getWeapon2().getTipo());
		frame.getContentPane().add(textField_3);
		if (JugarOnline.personaje1.getWeapon2().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (JugarOnline.personaje1.getWeapon2().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (JugarOnline.personaje1.getWeapon2().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (JugarOnline.personaje1.getWeapon2().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (JugarOnline.personaje1.getWeapon2().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!JugarOnline.personaje1.getWeapon2().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje1.getWeapon2().getDescription());
		}
		...
		if (JugarOnline.personaje1.getWeapon2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje1.getWeapon2().isLegendaria() == true) {
