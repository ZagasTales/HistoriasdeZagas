...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje1.getPoderes());
		...
		textArea.setText(JugarOnline.personaje1.getExtras());
		...
		textArea.setText(JugarOnline.personaje1.getModificadores());
