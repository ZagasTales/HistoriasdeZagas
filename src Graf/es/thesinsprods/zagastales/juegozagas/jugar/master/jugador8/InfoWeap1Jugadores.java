...
public class InfoWeap1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje8.getWeapon1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje8.getWeapon1().getPossesion().getPos();
		...
		textField_3.setText(JugarOnline.personaje8.getWeapon1().getTipo());
		frame.getContentPane().add(textField_3);
		if (JugarOnline.personaje8.getWeapon1().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (JugarOnline.personaje8.getWeapon1().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (JugarOnline.personaje8.getWeapon1().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (JugarOnline.personaje8.getWeapon1().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (JugarOnline.personaje8.getWeapon1().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!JugarOnline.personaje8.getWeapon1().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje8.getWeapon1().getDescription());
		}
		...
		if (JugarOnline.personaje8.getWeapon1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje8.getWeapon1().isLegendaria() == true) {
