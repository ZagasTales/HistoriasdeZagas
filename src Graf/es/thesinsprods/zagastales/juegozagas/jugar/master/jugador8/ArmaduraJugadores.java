...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje8.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje8.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje8.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje8.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje8.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje8.getArmor().isLegendaria() == true) {
