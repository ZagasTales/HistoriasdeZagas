...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje8.getPoderes());
		...
		textArea.setText(JugarOnline.personaje8.getExtras());
		...
		textArea.setText(JugarOnline.personaje8.getModificadores());
