...
public class DestrezasJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje8.getKnowhowSkills().getAthletics());
		...
		textField_1.setText(""+JugarOnline.personaje8.getKnowhowSkills().getSurvival());
		...
		textField_2.setText(""+JugarOnline.personaje8.getKnowhowSkills().getEquitation());
		...
		textField_3.setText(""+JugarOnline.personaje8.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""+JugarOnline.personaje8.getKnowhowSkills().getStealth());
