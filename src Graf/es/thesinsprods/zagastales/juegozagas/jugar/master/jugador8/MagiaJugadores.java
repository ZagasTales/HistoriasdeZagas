...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje8.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.personaje8.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.personaje8.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.personaje8.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.personaje8.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.personaje8.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.personaje8.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.personaje8.getMagicSkills().getArcane());
