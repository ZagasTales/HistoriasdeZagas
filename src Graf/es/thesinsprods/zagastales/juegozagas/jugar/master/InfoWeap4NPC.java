...
public class InfoWeap4NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.weapon4.isPosesion() == true ||ModificarEquipo.weapon4.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.weapon4.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap4NPC.class
				.getResource("/images/boton atras.png")));
		...
		txtesArrojadiza.setText(ModificarEquipo.weapon4.getTipo());
		...
		textField_3.setText(ModificarEquipo.weapon4.getTipo());
		textField_3.setBounds(10, 113, 115, 20);
		frame.getContentPane().add(textField_3);
		if (ModificarEquipo.weapon4.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (ModificarEquipo.weapon4.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (ModificarEquipo.weapon4.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (ModificarEquipo.weapon4.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (ModificarEquipo.weapon4.getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		textArea.setText(ModificarEquipo.weapon4.getDescription());
		...
		if (ModificarEquipo.weapon4.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.weapon4.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.weapon4.isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap4NPC.class
