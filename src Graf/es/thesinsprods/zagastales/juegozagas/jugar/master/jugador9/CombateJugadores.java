...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje9.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.personaje9.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.personaje9.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.personaje9.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.personaje9.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.personaje9.getCombatSkills().getBlock());
