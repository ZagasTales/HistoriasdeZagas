...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje9.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje9.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje9.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje9.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje9.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje9.getArmor().isLegendaria() == true) {
