...
public class DestrezasJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje9.getKnowhowSkills().getAthletics());
		...
		textField_1.setText(""+JugarOnline.personaje9.getKnowhowSkills().getSurvival());
		...
		textField_2.setText(""+JugarOnline.personaje9.getKnowhowSkills().getEquitation());
		...
		textField_3.setText(""+JugarOnline.personaje9.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""+JugarOnline.personaje9.getKnowhowSkills().getStealth());
