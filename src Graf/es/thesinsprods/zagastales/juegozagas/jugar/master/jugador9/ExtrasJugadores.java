...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje9.getPoderes());
		...
		textArea.setText(JugarOnline.personaje9.getExtras());
		...
		textArea.setText(JugarOnline.personaje9.getModificadores());
