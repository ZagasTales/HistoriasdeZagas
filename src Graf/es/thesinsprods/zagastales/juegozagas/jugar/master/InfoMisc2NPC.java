...
public class InfoMisc2NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.misc2.isPosesion() == true ||ModificarEquipo.misc2.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.misc2.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc2NPC.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(ModificarEquipo.misc2.getMisc());
		textArea.setText(ModificarEquipo.misc2.getDescription());
		...
		if (ModificarEquipo.misc2.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.misc2.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.misc2.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc2NPC.class
