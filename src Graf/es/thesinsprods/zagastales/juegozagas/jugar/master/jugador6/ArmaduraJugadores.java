...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje6.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje6.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje6.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje6.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje6.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje6.getArmor().isLegendaria() == true) {
