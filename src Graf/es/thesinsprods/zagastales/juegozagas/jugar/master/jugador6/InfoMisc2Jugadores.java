...
public class InfoMisc2Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje6.getMisc2().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje6.getMisc2().getPossesion().getPos();
		...
		textField.setText(JugarOnline.personaje6.getMisc2().getMisc());
		if(!JugarOnline.personaje6.getMisc2().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje6.getMisc2().getDescription());
		}
		...
		if (JugarOnline.personaje6.getMisc2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje6.getMisc2().isLegendaria() == true) {
