...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje6.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.personaje6.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.personaje6.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.personaje6.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.personaje6.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.personaje6.getCombatSkills().getBlock());
