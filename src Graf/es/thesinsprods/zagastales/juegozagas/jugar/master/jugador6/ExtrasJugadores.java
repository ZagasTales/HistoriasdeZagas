...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje6.getPoderes());
		...
		textArea.setText(JugarOnline.personaje6.getExtras());
		...
		textArea.setText(JugarOnline.personaje6.getModificadores());
