...
public class InfoMisc2Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc4.getMisc2().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc4.getMisc2().getPossesion().getPos();
		...
		textField.setText(JugarOnline.npc4.getMisc2().getMisc());
		if(!JugarOnline.npc4.getMisc2().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc4.getMisc2().getDescription());
		}
		...
		if (JugarOnline.npc4.getMisc2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc4.getMisc2().isLegendaria() == true) {
