...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc4.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.npc4.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.npc4.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.npc4.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.npc4.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.npc4.getCombatSkills().getBlock());
