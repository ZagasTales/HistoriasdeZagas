...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc4.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc4.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc4.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc4.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc4.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc4.getArmor().isLegendaria() == true) {
