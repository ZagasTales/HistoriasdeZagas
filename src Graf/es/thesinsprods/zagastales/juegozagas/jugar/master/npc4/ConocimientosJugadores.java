...
public class ConocimientosJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc4.getKnowledgeSkills().getArtofWar());
		...
		textField_1.setText(""+JugarOnline.npc4.getKnowledgeSkills().getDiplomacy());
		...
		textField_2.setText(""+JugarOnline.npc4.getKnowledgeSkills().getEtiquette());
		...
		textField_3.setText(""+JugarOnline.npc4.getKnowledgeSkills().getMedicine());
		...
		textField_4.setText(""+JugarOnline.npc4.getKnowledgeSkills().getOccultism());
		...
		textField_5.setText(""+JugarOnline.npc4.getKnowledgeSkills().getResearch());
		...
		textField_6.setText(""+JugarOnline.npc4.getKnowledgeSkills().getNegotiation());
		...
		textField_7.setText(""+JugarOnline.npc4.getKnowledgeSkills().getSecretKnowledge());
