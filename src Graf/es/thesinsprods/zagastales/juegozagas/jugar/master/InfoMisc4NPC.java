...
public class InfoMisc4NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.misc4.isPosesion() == true ||ModificarEquipo.misc4.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.misc4.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc4NPC.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(ModificarEquipo.misc4.getMisc());
		textArea.setText(ModificarEquipo.misc4.getDescription());
		...
		if (ModificarEquipo.misc4.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.misc4.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.misc4.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc4NPC.class
