...
public class InfoAcc3NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.accesories3.isPosesion() == true || ModificarEquipo.accesories3.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.accesories3.getPossesion()
					.getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(InfoAcc3NPC.class
		...
		if (ModificarEquipo.accesories3.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (ModificarEquipo.accesories3.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (ModificarEquipo.accesories3.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (ModificarEquipo.accesories3.getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		textArea.setText(ModificarEquipo.accesories3.getDescription());
		...
		if (ModificarEquipo.accesories3.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.accesories3.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.accesories3.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoAcc3NPC.class
