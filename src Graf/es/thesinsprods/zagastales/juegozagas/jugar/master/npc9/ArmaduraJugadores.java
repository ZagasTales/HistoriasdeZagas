...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc9.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc9.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc9.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc9.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc9.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc9.getArmor().isLegendaria() == true) {
