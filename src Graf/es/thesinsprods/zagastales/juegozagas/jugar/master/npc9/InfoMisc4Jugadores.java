...
public class InfoMisc4Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc9.getMisc4().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc9.getMisc4().getPossesion().getPos();
		...
		textField.setText(JugarOnline.npc9.getMisc4().getMisc());
		if(!JugarOnline.npc9.getMisc4().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc9.getMisc4().getDescription());
		}
		...
		if (JugarOnline.npc9.getMisc4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc9.getMisc4().isLegendaria() == true) {
