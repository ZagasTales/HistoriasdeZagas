...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc9.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.npc9.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.npc9.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.npc9.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.npc9.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.npc9.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.npc9.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.npc9.getMagicSkills().getArcane());
