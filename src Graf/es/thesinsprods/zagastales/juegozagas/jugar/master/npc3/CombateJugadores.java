...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc3.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.npc3.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.npc3.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.npc3.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.npc3.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.npc3.getCombatSkills().getBlock());
