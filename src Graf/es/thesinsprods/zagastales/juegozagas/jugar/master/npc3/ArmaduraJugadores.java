...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc3.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc3.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc3.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc3.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc3.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc3.getArmor().isLegendaria() == true) {
