...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje5.getMisc1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje5.getMisc1().getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc1Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(JugarOnline.personaje5.getMisc1().getMisc());
		if(!JugarOnline.personaje5.getMisc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje5.getMisc1().getDescription());
		}
		...
		if (JugarOnline.personaje5.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje5.getMisc1().isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc1Jugadores.class
