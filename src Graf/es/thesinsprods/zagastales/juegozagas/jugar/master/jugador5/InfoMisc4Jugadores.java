...
public class InfoMisc4Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje5.getMisc4().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje5.getMisc4().getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc4Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(JugarOnline.personaje5.getMisc4().getMisc());
		if(!JugarOnline.personaje5.getMisc4().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje5.getMisc4().getDescription());
		}
		...
		if (JugarOnline.personaje5.getMisc4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje5.getMisc4().isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc4Jugadores.class
