...
public class InfoWeap3Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje5.getWeapon3().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje5.getWeapon3().getPossesion().getPos();
		...
		textField_3.setText(JugarOnline.personaje5.getWeapon3().getTipo());
		frame.getContentPane().add(textField_3);
		if (JugarOnline.personaje5.getWeapon3().getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (JugarOnline.personaje5.getWeapon3().getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (JugarOnline.personaje5.getWeapon3().getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (JugarOnline.personaje5.getWeapon3().getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (JugarOnline.personaje5.getWeapon3().getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		if(!JugarOnline.personaje5.getWeapon3().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje5.getWeapon3().getDescription());
		}
		...
		if (JugarOnline.personaje5.getWeapon3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje5.getWeapon3().isLegendaria() == true) {
