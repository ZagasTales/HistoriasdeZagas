...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje5.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje5.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.personaje5.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje5.getArmor().getDescription());
		}
		...
		if (JugarOnline.personaje5.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.personaje5.getArmor().isLegendaria() == true) {
