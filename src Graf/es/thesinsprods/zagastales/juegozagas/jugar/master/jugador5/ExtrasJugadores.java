...
public class ExtrasJugadores {
	...
	private void initialize() {
		...
		textArea.setText(JugarOnline.personaje5.getPoderes());
		...
		textArea.setText(JugarOnline.personaje5.getExtras());
		...
		textArea.setText(JugarOnline.personaje5.getModificadores());
