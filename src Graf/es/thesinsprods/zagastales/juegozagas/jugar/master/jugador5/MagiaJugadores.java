...
public class MagiaJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.personaje5.getMagicSkills().getFire());
		...
		textField_1.setText(""+JugarOnline.personaje5.getMagicSkills().getWater());
		...
		textField_2.setText(""+JugarOnline.personaje5.getMagicSkills().getEarth());
		...
		textField_3.setText(""+JugarOnline.personaje5.getMagicSkills().getWind());
		...
		textField_4.setText(""+JugarOnline.personaje5.getMagicSkills().getDruidic());
		...
		textField_5.setText(""+JugarOnline.personaje5.getMagicSkills().getWhite());
		...
		textField_6.setText(""+JugarOnline.personaje5.getMagicSkills().getBlack());
		...
		textField_7.setText(""+JugarOnline.personaje5.getMagicSkills().getArcane());
