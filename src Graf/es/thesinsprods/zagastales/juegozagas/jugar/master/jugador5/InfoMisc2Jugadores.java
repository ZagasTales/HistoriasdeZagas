...
public class InfoMisc2Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.personaje5.getMisc2().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.personaje5.getMisc2().getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc2Jugadores.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(JugarOnline.personaje5.getMisc2().getMisc());
		if(!JugarOnline.personaje5.getMisc2().getDescription().equals("null")){
		textArea.setText(JugarOnline.personaje5.getMisc2().getDescription());
		}
		...
		if (JugarOnline.personaje5.getMisc2().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.personaje5.getMisc2().isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc2Jugadores.class
