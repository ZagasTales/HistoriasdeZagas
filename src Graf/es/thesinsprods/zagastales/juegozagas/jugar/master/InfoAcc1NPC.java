...
public class InfoAcc1NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.accesories1.isPosesion() == true || ModificarEquipo.accesories1.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.accesories1.getPossesion()
					.getPos();
		...
		if (ModificarEquipo.accesories1.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (ModificarEquipo.accesories1.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (ModificarEquipo.accesories1.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (ModificarEquipo.accesories1.getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		textArea.setText(ModificarEquipo.accesories1.getDescription());
		...
		if (ModificarEquipo.accesories1.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.accesories1.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.accesories1.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoAcc1NPC.class
