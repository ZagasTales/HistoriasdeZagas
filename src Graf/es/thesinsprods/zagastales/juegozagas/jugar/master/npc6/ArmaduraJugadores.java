...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc6.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc6.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc6.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc6.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc6.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc6.getArmor().isLegendaria() == true) {
