...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc6.getMisc1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc6.getMisc1().getPossesion().getPos();
		...
		textField.setText(JugarOnline.npc6.getMisc1().getMisc());
		if(!JugarOnline.npc6.getMisc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc6.getMisc1().getDescription());
		}
		...
		if (JugarOnline.npc6.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc6.getMisc1().isLegendaria() == true) {
