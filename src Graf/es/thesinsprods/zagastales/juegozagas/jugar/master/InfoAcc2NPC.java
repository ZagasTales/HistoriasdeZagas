...
public class InfoAcc2NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.accesories2.isPosesion() == true || ModificarEquipo.accesories2.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.accesories2.getPossesion()
					.getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(InfoAcc2NPC.class
		...
		if (ModificarEquipo.accesories2.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (ModificarEquipo.accesories2.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (ModificarEquipo.accesories2.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (ModificarEquipo.accesories2.getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}

		textArea.setText(ModificarEquipo.accesories2.getDescription());
		...
		if (ModificarEquipo.accesories2.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.accesories2.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.accesories2.isLegendaria() == true) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoAcc2NPC.class
