...
public class DestrezasJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc2.getKnowhowSkills().getAthletics());
		...
		textField_1.setText(""+JugarOnline.npc2.getKnowhowSkills().getSurvival());
		...
		textField_2.setText(""+JugarOnline.npc2.getKnowhowSkills().getEquitation());
		...
		textField_3.setText(""+JugarOnline.npc2.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""+JugarOnline.npc2.getKnowhowSkills().getStealth());
