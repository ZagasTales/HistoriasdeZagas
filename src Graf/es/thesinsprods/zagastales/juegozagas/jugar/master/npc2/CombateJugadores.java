...
public class CombateJugadores {
	...
	private void initialize() {
		...
		textField.setText(""+JugarOnline.npc2.getCombatSkills().getOneHanded());
		...
		textField_1.setText(""+JugarOnline.npc2.getCombatSkills().getTwoHanded());
		...
		textField_2.setText(""+JugarOnline.npc2.getCombatSkills().getPole());
		...
		textField_3.setText(""+JugarOnline.npc2.getCombatSkills().getRanged());
		...
		textField_4.setText(""+JugarOnline.npc2.getCombatSkills().getDodge());
		...
		textField_5.setText(""+JugarOnline.npc2.getCombatSkills().getBlock());
