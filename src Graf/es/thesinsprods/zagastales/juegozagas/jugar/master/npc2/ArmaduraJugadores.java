...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc2.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc2.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc2.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc2.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc2.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc2.getArmor().isLegendaria() == true) {
