...
public class InfoWeap3NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.weapon3.isPosesion() == true ||ModificarEquipo.weapon3.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.weapon3.getPossesion().getPos();
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(InfoAcc1NPC.class
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap3NPC.class
				.getResource("/images/boton atras.png")));
		...
		txtesArrojadiza.setText(ModificarEquipo.weapon3.getTipo());
		...
		textField_3.setText(ModificarEquipo.weapon3.getTipo());
		textField_3.setBounds(10, 113, 115, 20);
		frame.getContentPane().add(textField_3);
		if (ModificarEquipo.weapon3.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (ModificarEquipo.weapon3.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (ModificarEquipo.weapon3.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (ModificarEquipo.weapon3.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (ModificarEquipo.weapon3.getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		textArea.setText(ModificarEquipo.weapon3.getDescription());
		...
		if (ModificarEquipo.weapon3.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.weapon3.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.weapon3.isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap3NPC.class
