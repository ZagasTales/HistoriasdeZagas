...
public class InfoWeap2NPC {
	...
	private void initialize() {
		...
		if (ModificarEquipo.weapon2.isPosesion() == true ||ModificarEquipo.weapon2.isLegendaria() == true) {

			ArrayList<String> pos = ModificarEquipo.weapon2.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap2NPC.class
				.getResource("/images/boton atras.png")));
		...
		txtesArrojadiza.setText(ModificarEquipo.weapon2.getTipo());
		...
		textField_3.setText(ModificarEquipo.weapon2.getTipo());
		textField_3.setBounds(10, 113, 115, 20);
		frame.getContentPane().add(textField_3);
		if (ModificarEquipo.weapon2.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (ModificarEquipo.weapon2.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (ModificarEquipo.weapon2.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (ModificarEquipo.weapon2.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (ModificarEquipo.weapon2.getClass().getSimpleName().equals("Shields")) {
			textField.setText("Escudo");
		}
		textArea.setText(ModificarEquipo.weapon2.getDescription());
		...
		if (ModificarEquipo.weapon2.isPosesion() == true) {
			textField_4.setText("Posesión");
		}
		if (ModificarEquipo.weapon2.isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (ModificarEquipo.weapon2.isLegendaria() == true) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap2NPC.class
