...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc8.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc8.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc8.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc8.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc8.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc8.getArmor().isLegendaria() == true) {
