...
public class InfoMisc1Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc8.getMisc1().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc8.getMisc1().getPossesion().getPos();
		...
		textField.setText(JugarOnline.npc8.getMisc1().getMisc());
		if(!JugarOnline.npc8.getMisc1().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc8.getMisc1().getDescription());
		}
		...
		if (JugarOnline.npc8.getMisc1().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc8.getMisc1().isLegendaria() == true) {
