...
public class InfoAcc4Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc8.getAcc4().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc8.getAcc4().getPossesion().getPos();
		...
		if (JugarOnline.npc8.getAcc4().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (JugarOnline.npc8.getAcc4().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (JugarOnline.npc8.getAcc4().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (JugarOnline.npc8.getAcc4().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}
		if(!JugarOnline.npc8.getAcc4().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc8.getAcc4().getDescription());
		}
		...
		if (JugarOnline.npc8.getAcc4().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc8.getAcc4().isLegendaria() == true) {
