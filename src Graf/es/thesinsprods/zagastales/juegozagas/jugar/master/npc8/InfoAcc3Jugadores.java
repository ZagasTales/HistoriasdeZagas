...
public class InfoAcc3Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc8.getAcc3().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc8.getAcc3().getPossesion().getPos();
		...
		if (JugarOnline.npc8.getAcc3().getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (JugarOnline.npc8.getAcc3().getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (JugarOnline.npc8.getAcc3().getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (JugarOnline.npc8.getAcc3().getClass().getSimpleName().equals("Rings")) {
			textField.setText("Anillos");
		}
		if(!JugarOnline.npc8.getAcc3().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc8.getAcc3().getDescription());
		}
		...
		if (JugarOnline.npc8.getAcc3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc8.getAcc3().isLegendaria() == true) {
