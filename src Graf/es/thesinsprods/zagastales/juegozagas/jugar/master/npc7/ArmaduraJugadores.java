...
public class ArmaduraJugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc7.getArmor().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc7.getArmor().getPossesion().getPos();
		...
		if(!JugarOnline.npc7.getArmor().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc7.getArmor().getDescription());
		}
		...
		if (JugarOnline.npc7.getArmor().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		
		if (JugarOnline.npc7.getArmor().isLegendaria() == true) {
