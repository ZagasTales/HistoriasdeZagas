...
public class InfoMisc3Jugadores {
	...
	private void initialize() {
		...
		if (JugarOnline.npc7.getMisc3().isPosesion() == true) {

			ArrayList<String> pos = JugarOnline.npc7.getMisc3().getPossesion().getPos();
		...
		textField.setText(JugarOnline.npc7.getMisc3().getMisc());
		if(!JugarOnline.npc7.getMisc3().getDescription().equals("null")){
		textArea.setText(JugarOnline.npc7.getMisc3().getDescription());
		}
		...
		if (JugarOnline.npc7.getMisc3().isPosesion() == false) {
			textField_4.setText("Normal");
		}
		if (JugarOnline.npc7.getMisc3().isLegendaria() == true) {
