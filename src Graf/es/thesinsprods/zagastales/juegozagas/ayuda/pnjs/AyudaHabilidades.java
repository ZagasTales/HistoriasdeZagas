...
public class AyudaHabilidades {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("A la hora de asignar nuestros puntos de habilidades, contaremos con un total de 60 puntos a repartir en las cuatro ramas que se ven en la pantalla de habilidades.\n\nPulsa en el botón de cada grupo de habilidades para abrir una nueva ventana en la que se podrán ver los componentes de cada uno de ellos. Según tu raza o bendición podrás tener ya asignados algunos puntos de forma inicial. Para aumentar o disminuir los puntos de cada habilidad, pulsa el botón + o -. Los puntos necesarios para aumentar dicha habilidad se restarán automáticamente.");
