...
public class AyudaPrivilegios {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Los privilegios son aquellos puntos fuertes o habilidades en las que el personaje destaca mientras que los reveses representan los puntos débiles. El personaje debe poseer como mínimo un privilegio, pero tendrá la capacidad de tener más, hasta un máximo de 5. A partir del segundo privilegio será necesario añadir un revés por cada privilegio que se añada.\n\n Para elegir un privilegio o un revés, selecciónalo en su pestaña, y su efecto se mostrará en el cuadro de texto a la derecha.");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				btnNewButton.setIcon(new ImageIcon(AyudaPrivilegios.class
		...
		button.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button.setIcon(new ImageIcon(AyudaPrivilegios.class
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaPrivilegios.class
		...
		label.setIcon(new ImageIcon(AyudaPrivilegios.class
