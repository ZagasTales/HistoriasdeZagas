...
public class AyudaBendicion {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Tener una bendición significa estar bajo la protección de un Dios al que se amparará el personaje. Cada una ofrece diferentes ventajas.\n\nPara elegir la bendición selecciona la pestaña y aparecerá una lista con todas las bendiciones disponibles. Una vez elegida, su descripción y efectos se mostrarán en el cuadro de texto de la derecha, situándose estos últimos al final de la descripción.");
		...
		button.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button.setIcon(new ImageIcon(AyudaBendicion.class
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaBendicion.class
		...
		label.setIcon(new ImageIcon(AyudaBendicion.class
