...
public class AyudaStart {
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon(AyudaStart.class
				.getResource("/images/boton a\u00F1adir.png")));
		...
		button.setIcon(new ImageIcon(AyudaStart.class
				.getResource("/images/boton continuar.png")));
		...
		label.setIcon(new ImageIcon(AyudaStart.class
