...
public class AyudaAtributosNPC {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Los atributos son las características del NPC, y cada uno de ellos determina lo eficaz que va a ser el NPC en dicha característica. Cada atributo puede tener inicialmente un mínimo de seis puntos, y se pueden asignar tantos puntos como se desee a cada uno hasta un máximo de 19.\n\nLos puntos disponibles se muestran en la esquina inferior izquierda. Utiliza los botones “+” y “-” para añadir o retirar atributos. Los botones se bloquearán automáticamente cuando se llegue al máximo o al mínimo permitidos");
