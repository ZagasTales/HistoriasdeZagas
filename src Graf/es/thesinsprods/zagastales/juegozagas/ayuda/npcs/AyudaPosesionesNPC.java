...
public class AyudaPosesionesNPC {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Las posesiones son todas aquellas armas, armaduras, objetos o accesorios que poseen propiedades especiales. Para poder elegir las propiedades de dichos artefactos, se cuenta con 3 puntos para añadir propiedades a una posesión. Se pueden añadir propiedades siempre y cuando queden puntos de posesión.\n\nLas posesiones se añaden pulsando e n el botón de “posesión”. Se abrirá una nueva ventana donde habrá que indicar qué tipo de equipo es la posesión (arma, armadura, objeto o accesorio), su nombre, una descripción (opcional) y las propiedades que posea. Las propiedades pueden elegirse entre las que hay prefijadas o inventarse una completamente nueva.");
		...
		button_1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaPosesionesNPC.class
		...
		label.setIcon(new ImageIcon(AyudaPosesionesNPC.class
