...
public class AyudaBendicionNPC {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Tener una bendición significa estar bajo la protección de un Dios al que se vaya a amparar el NPC. Cada una ofrece diferentes ventajas.\n\nPara elegir la bendición selecciona la pestaña y aparecerá una lista con todas las bendiciones disponibles. Una vez elegida, su descripción y efectos se mostrarán en el cuadro de texto de la derecha, situándose estos últimos al final de la descripción. Si el NPC fuera además campeón del dios elegido se debe marcar la casilla de “¿Campeón?” Situada abajo a la izquierda. ");
		...
		txtrLoPrimeroQue.setBounds(10, 67, 414, 140);
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaBendicionNPC.class
		...
		label.setIcon(new ImageIcon(AyudaBendicionNPC.class
