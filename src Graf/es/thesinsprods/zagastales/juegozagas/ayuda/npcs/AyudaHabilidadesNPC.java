...
public class AyudaHabilidadesNPC {
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Para determinar las habilidades del NPC se deben subir puntos en aquellas que se cuenta con un total de cuatro ramas que se ven en la pantalla de habilidades. A más puntos asignados en una habilidad mejor será el NPC en esta.\n\nAl pulsar en cada grupo de habilidades se abrirá una nueva ventana en la que se podrán ver los componentes de cada uno de ellos. Según la raza o bendición del NPC este podría tener ya asignados algunos puntos de forma inicial. Para aumentar o disminuir los puntos de cada habilidad, pulsa los botones + o -. ");
