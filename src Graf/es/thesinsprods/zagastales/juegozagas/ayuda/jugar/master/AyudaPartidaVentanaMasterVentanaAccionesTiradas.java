...
public class AyudaPartidaVentanaMasterVentanaAccionesTiradas {
	 ...
	 */
	public AyudaPartidaVentanaMasterVentanaAccionesTiradas() {
		initialize();
	}
	...
	private void initialize() {
		...
		txtrLoPrimeroQue
				.setText("Todas las tiradas de la partida se realizan aqu\u00ED. Las tiradas enfrentadas cuando un personaje o NPC realiza una tirada contra otro personaje o NPC, las tiradas aleatorias cuando se necesita una tirada de cualquier tipo si no se tira contra otra. Por \u00FAltimo las tiradas de impacto son las utilizadas para calcular el da\u00F1o de un ataque que el jugador o NPC.\r\n");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				btnNewButton.setIcon(new ImageIcon(AyudaPartidaVentanaMasterVentanaAccionesTiradas.class
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaPartidaVentanaMasterVentanaAccionesTiradas.class
		...
		button_1.setIcon(new ImageIcon(AyudaPartidaVentanaMasterVentanaAccionesTiradas.class.getResource("/images/boton continuar.png")));
		button_1.setHorizontalTextPosition(SwingConstants.CENTER);
		button_1.setForeground(Color.WHITE);
		button_1.setContentAreaFilled(false);
		button_1.setBorderPainted(false);
		button_1.setBorder(null);
		button_1.setBounds(312, 170, 99, 38);
		contentPanel.add(button_1);

		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(AyudaPartidaVentanaMasterVentanaAccionesTiradas.class
