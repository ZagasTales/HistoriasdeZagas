...
public class AyudaPartidaVentanaMasterPartida {
	 ...
	 */
	public AyudaPartidaVentanaMasterPartida() {
		initialize();
	}
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 439, 237);
		...
		txtrLoPrimeroQue
				.setText("Gestiona todos los personajes y NPCs  de la partida. Se pueden cargar y eliminar desde la barra de herramientas arriba a la izquierda de la ventana. Se puede tener hasta un m\u00E1ximo de 9 en cada categor\u00EDa.");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				btnNewButton.setIcon(new ImageIcon(AyudaPartidaVentanaMasterPartida.class
		...
		btnNewButton.setBounds(165, 159, 120, 34);
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				button_1.setIcon(new ImageIcon(AyudaPartidaVentanaMasterPartida.class
		...
		button_1.setBounds(30, 159, 99, 38);
		contentPanel.add(button_1);

		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(AyudaPartidaVentanaMasterPartida.class
