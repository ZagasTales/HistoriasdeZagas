...
public class InfoArm1 {
	...
	private void initialize() {
		...
		if (Equipo.armor1.isPosesion() == true) {

			ArrayList<String> pos = Equipo.armor1.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoArm1.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(Equipo.armor1.getArmor());
		textArea.setText(Equipo.armor1.getDescription());
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoArm1.class
