...
public class Destrezas {
	...
	private void initialize() {
		...
		txtPuntos.setBounds(10, 301, 62, 20);
		...
		textField_3.setText("" + Start.character.getKnowhowSkills().getTraps());
		...
		textField_4.setText(""
				+ Start.character.getKnowhowSkills().getStealth());
		...
		textField_5.setText("" + Start.skpoints.getPoints());
		textField_5.setHorizontalAlignment(SwingConstants.CENTER);
		textField_5.setFont(mf.MyFont(0, 15));
		textField_5.setEditable(false);
		textField_5.setColumns(10);
		textField_5.setBounds(82, 301, 31, 20);
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				button.setIcon(new ImageIcon(Destrezas.class
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_1.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_2.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_3.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_4.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_5.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_5.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_6.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_6.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_7.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_7.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_8.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_8.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		button_9.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_9.setIcon(new ImageIcon(Destrezas.class
						.getResource("/images/boton +-2.png")));
		...
		if (Start.character.getKnowhowSkills().getAthletics() == minAtl) {
			button_5.setEnabled(false);
		}
		if (Start.character.getKnowhowSkills().getSurvival() == minSup) {
			button_6.setEnabled(false);
		}
		if (Start.character.getKnowhowSkills().getEquitation() == minEq) {
			button_7.setEnabled(false);
		}
		if (Start.character.getKnowhowSkills().getTraps() == minTra) {
			button_8.setEnabled(false);
		}
		if (Start.character.getKnowhowSkills().getStealth() == minSig) {
			button_9.setEnabled(false);
		}
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (Start.character.getKnowhowSkills().getAthletics() == 4
							&& Start.character.getPrivileges()
									.Search("Maestro")) {
						Start.character.getKnowhowSkills().increaseAthletics(
								Start.skpoints);
						textField.setText(""
								+ Start.character.getKnowhowSkills()
										.getAthletics());
						textField_5.setText("" + Start.skpoints.getPoints());
					}
					if (Start.character.getKnowhowSkills().getAthletics() == 3
							&& Start.character.getPrivileges()
					...
					if (Start.character.getKnowhowSkills().getAthletics() == 2
					...
					if (Start.character.getKnowhowSkills().getAthletics() < 3
						...
						if (Start.character.getKnowhowSkills().getAthletics() < 2) {
							Start.character.getKnowhowSkills()
									.increaseAthletics(Start.skpoints);
							textField.setText(""
									+ Start.character.getKnowhowSkills()
											.getAthletics());
							textField_5.setText("" + Start.skpoints.getPoints());
					...
					if (Start.character.getKnowhowSkills().getAthletics() >= 5) {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (Start.character.getKnowhowSkills().getSurvival() == 4
							&& Start.character.getPrivileges()
									.Search("Maestro")) {
						Start.character.getKnowhowSkills().increaseSurvival(
								Start.skpoints);
						textField_1.setText(""
								+ Start.character.getKnowhowSkills()
										.getSurvival());
					...
					if (Start.character.getKnowhowSkills().getSurvival() == 3
							&& Start.character.getPrivileges()
									.Search("Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (Start.character.getKnowhowSkills().getSurvival() == 2
							&& Start.character.getSetbacks().Search("Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
										frame.getContentPane(),
					...
					if (Start.character.getKnowhowSkills().getSurvival() < 3
						...
						if (Start.character.getKnowhowSkills().getSurvival() < 2) {
							Start.character.getKnowhowSkills()
									.increaseSurvival(Start.skpoints);
							textField_1.setText(""
									+ Start.character.getKnowhowSkills()
											.getSurvival());
							textField_5.setText("" + Start.skpoints.getPoints());
					...
					if (Start.character.getKnowhowSkills().getSurvival() >= 5) {
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (Start.character.getKnowhowSkills().getEquitation() == 4
							&& Start.character.getPrivileges()
									.Search("Maestro")) {
						Start.character.getKnowhowSkills().increaseEquitation(
								Start.skpoints);
						textField_2.setText(""
								+ Start.character.getKnowhowSkills()
										.getEquitation());
					...
					if (Start.character.getKnowhowSkills().getEquitation() == 3
							&& Start.character.getPrivileges()
									.Search("Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (Start.character.getKnowhowSkills().getEquitation() == 2
							&& Start.character.getSetbacks().Search("Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
										frame.getContentPane(),
					...
					if (Start.character.getKnowhowSkills().getEquitation() < 3
						...
						if (Start.character.getKnowhowSkills().getEquitation() < 2) {
							Start.character.getKnowhowSkills()
									.increaseEquitation(Start.skpoints);
							textField_2.setText(""
									+ Start.character.getKnowhowSkills()
											.getEquitation());
							textField_5.setText("" + Start.skpoints.getPoints());
					...
					if (Start.character.getKnowhowSkills().getEquitation() >= 5) {
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (Start.character.getKnowhowSkills().getTraps() == 4
							&& Start.character.getPrivileges()
									.Search("Maestro")) {
						Start.character.getKnowhowSkills().increaseTraps(
								Start.skpoints);
						textField_3
								.setText(""
										+ Start.character.getKnowhowSkills()
					...
					if (Start.character.getKnowhowSkills().getTraps() == 3
							&& Start.character.getPrivileges()
									.Search("Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (Start.character.getKnowhowSkills().getTraps() == 2
							&& Start.character.getSetbacks().Search("Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
										frame.getContentPane(),
					...
					if (Start.character.getKnowhowSkills().getTraps() >= 5) {
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (Start.character.getKnowhowSkills().getStealth() == 4
							&& Start.character.getPrivileges()
									.Search("Maestro")) {
						Start.character.getKnowhowSkills().increaseStealth(
								Start.skpoints);
						textField_4.setText(""
								+ Start.character.getKnowhowSkills()
										.getStealth());
					...
					if (Start.character.getKnowhowSkills().getStealth() == 3
							&& Start.character.getPrivileges()
									.Search("Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (Start.character.getKnowhowSkills().getStealth() == 2
							&& Start.character.getSetbacks().Search("Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
										frame.getContentPane(),
					...
					if (Start.character.getKnowhowSkills().getStealth() >= 5) {
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Start.character.getKnowhowSkills().decreaseAthletics(
							Start.skpoints);
					textField
							.setText(""
									+ Start.character.getKnowhowSkills()
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Start.character.getKnowhowSkills().decreaseSurvival(
							Start.skpoints);
					textField_1.setText(""
							+ Start.character.getKnowhowSkills().getSurvival());
					textField_5.setText("" + Start.skpoints.getPoints());
		...
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Start.character.getKnowhowSkills().decreaseEquitation(
							Start.skpoints);
					textField_2.setText(""
							+ Start.character.getKnowhowSkills()
									.getEquitation());
		...
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Start.character.getKnowhowSkills().decreaseTraps(
							Start.skpoints);
					textField_3.setText(""
							+ Start.character.getKnowhowSkills().getTraps());
					textField_5.setText("" + Start.skpoints.getPoints());
					if (Start.character.getKnowhowSkills().getTraps() < 5) {
		...
		button_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Start.character.getKnowhowSkills().decreaseStealth(
							Start.skpoints);
					textField_4.setText(""
							+ Start.character.getKnowhowSkills().getStealth());
					textField_5.setText("" + Start.skpoints.getPoints());
		...
		btnVolverAHabilidades.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				btnVolverAHabilidades.setIcon(new ImageIcon(Destrezas.class
		...
		label.setIcon(new ImageIcon(Destrezas.class
