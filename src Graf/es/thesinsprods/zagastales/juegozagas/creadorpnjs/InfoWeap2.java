...
public class InfoWeap2 {
	...
	private void initialize() {
		...
		if (Equipo.weapon2.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.weapon2.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoWeap1.class
				.getResource("/images/boton atras.png")));
		...
		if (Equipo.weapon2.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (Equipo.weapon2.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (Equipo.weapon2.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (Equipo.weapon2.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
			
		}
		if (Equipo.weapon2.getClass().getSimpleName().equals("Shields")) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoWeap1.class
