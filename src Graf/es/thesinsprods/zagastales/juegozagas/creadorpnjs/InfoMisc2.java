...
public class InfoMisc2 {
	...
	private void initialize() {
		...
		if (Equipo.misc2.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.misc2.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc2.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(Equipo.misc2.getMisc());
		...
		txtDescripcin_1.setBounds(135, 20, 90, 20);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc2.class
