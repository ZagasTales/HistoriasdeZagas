...
public class InfoAcc2 {
	...
	private void initialize() {
		...
		if (Equipo.accesories2.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.accesories2.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoAcc2.class
				.getResource("/images/boton atras.png")));
		...
		if (Equipo.accesories2.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (Equipo.accesories2.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (Equipo.accesories2.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (Equipo.accesories2.getClass().getSimpleName().equals("Rings")) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoAcc2.class
