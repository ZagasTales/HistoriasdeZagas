	...
	private void initialize() {
		...
		btnAadir.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				btnAadir.setIcon(new ImageIcon(Armadura.class
			...
			public void actionPerformed(ActionEvent arg0) {
				if (Equipo.getTextField_12().getText().equals("")) {
					...
					if (chckbxTela.isSelected() == true) {
						Equipo.armor1 = new Armor("Tela", textArea_1.getText(),
								false,false, Equipo.posss);
					}
					if (chckbxArmaduraLigera.isSelected() == true
							&& Start.character.getAtributes().getStrength() > 8) {
						Equipo.armor1 = new Armor("Armadura Ligera", textArea_1
								.getText(), false,false, Equipo.posss);
					}
					if (chckbxArmaduraLigera.isSelected() == true
							&& Start.character.getAtributes().getStrength() <= 8) {
						...
						try {
							...
							Equipo.armor1 = new Armor("Armadura Ligera",
									textArea_1.getText(), false,false, Equipo.posss);
					...
					if (chckbxArmaduraPesada.isSelected() == true
						...
						try {
							Start.character.getAtributes().setDexterity(
									dexN - 1);
							Equipo.armor1 = new Armor("Armadura Pesada",
									textArea_1.getText(), false,false, Equipo.posss);
						} catch (AtributeOutOfBoundsException e1) {
							JOptionPane
									.showMessageDialog(
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(Armadura.class
		...
		lblNewLabel.setIcon(new ImageIcon(Armadura.class
