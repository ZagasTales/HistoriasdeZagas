...
public class InfoWeap3 {
	...
	private void initialize() {
		...
		if (Equipo.weapon3.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.weapon3.getPossesion().getPos();
		...
		if (Equipo.weapon3.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (Equipo.weapon3.getClass().getSimpleName().equals("TwoHanded")) {
