...
public class InfoAcc1 {
	...
	private void initialize() {
		...
		if (Equipo.accesories1.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.accesories1.getPossesion().getPos();
		...
		if (Equipo.accesories1.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (Equipo.accesories1.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (Equipo.accesories1.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (Equipo.accesories1.getClass().getSimpleName().equals("Rings")) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoAcc1.class
