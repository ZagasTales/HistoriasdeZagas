...
public class InfoWeap4 {
	...
	private void initialize() {
		...
		if (Equipo.weapon4.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.weapon4.getPossesion().getPos();
		...
		if (Equipo.weapon4.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (Equipo.weapon4.getClass().getSimpleName().equals("TwoHanded")) {
