...
public class InfoMisc1 {
	...
	private void initialize() {
		...
		if (Equipo.misc1.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.misc1.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoMisc1.class
				.getResource("/images/boton atras.png")));
		...
		textField.setText(Equipo.misc1.getMisc());
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(InfoMisc1.class
