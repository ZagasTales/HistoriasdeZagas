...
public class InfoAcc3 {
	...
	private void initialize() {
		...
		if (Equipo.accesories3.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.accesories3.getPossesion().getPos();
		...
		btnVolver.setIcon(new ImageIcon(InfoAcc3.class
				.getResource("/images/boton atras.png")));
		...
		btnVolver.setBounds(10, 207, 99, 45);
		frame.getContentPane().add(btnVolver);
		if (Equipo.accesories3.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (Equipo.accesories3.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (Equipo.accesories3.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (Equipo.accesories3.getClass().getSimpleName().equals("Rings")) {
		...
		lblNewLabel.setIcon(new ImageIcon(InfoAcc3.class
				.getResource("/images/background-infos.jpg")));
		lblNewLabel.setBounds(0, -5, 374, 278);
