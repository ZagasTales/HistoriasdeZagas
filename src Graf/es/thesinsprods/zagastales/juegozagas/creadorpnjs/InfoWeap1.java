...
public class InfoWeap1 {
	...
	private void initialize() {
		...
		if (Equipo.weapon1.isPosesion() == true) {
			...
			ArrayList<String> pos = Equipo.weapon1.getPossesion().getPos();
		...
		if (Equipo.weapon1.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (Equipo.weapon1.getClass().getSimpleName().equals("TwoHanded")) {
