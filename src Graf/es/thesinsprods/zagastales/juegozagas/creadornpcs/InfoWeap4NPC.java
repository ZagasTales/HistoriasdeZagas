...
public class InfoWeap4NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.weapon4.isPosesion() == true ||EquipoNPC.weapon4.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.weapon4.getPossesion().getPos();
		...
		txtesArrojadiza.setText(EquipoNPC.weapon4.getTipo());
		...
		if (EquipoNPC.weapon4.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (EquipoNPC.weapon4.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (EquipoNPC.weapon4.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (EquipoNPC.weapon4.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (EquipoNPC.weapon4.getClass().getSimpleName().equals("Shields")) {
