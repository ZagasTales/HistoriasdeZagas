...
public class InfoAcc4NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.accesories4.isPosesion() == true || EquipoNPC.accesories4.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.accesories4.getPossesion()
					.getPos();
		...
		if (EquipoNPC.accesories4.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (EquipoNPC.accesories4.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (EquipoNPC.accesories4.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (EquipoNPC.accesories4.getClass().getSimpleName().equals("Rings")) {
