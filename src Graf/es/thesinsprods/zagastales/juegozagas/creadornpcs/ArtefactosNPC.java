...
public class ArtefactosNPC {
	...
	private void initialize() {
		...
		txtquEsTu.setText("\u00BFQu\u00E9 es tu artefacto legendario?");
		txtquEsTu.setFont(mf.MyFont(0, 13));
		txtquEsTu.setEditable(false);
		txtquEsTu.setColumns(10);
		txtquEsTu.setBorder(null);
		txtquEsTu.setBounds(10, 59, 189, 20);
		frame.getContentPane().add(txtquEsTu);

		final JComboBox<String> comboBox = new JComboBox<String>();
		comboBox.setBackground(Color.WHITE);

		comboBox.setModel(new DefaultComboBoxModel(new String[] {"-Artefacto-", "Armadura", "Arma", "Objeto", "Accesorio"}));
		comboBox.setFont(mf.MyFont(0, 13));
		comboBox.setBounds(10, 90, 99, 20);
		...
		txtPosesionesRestantes.setText("Artefactos Restantes:");
		...
		textField_1.setText("" + StartNPC.contadorLegendario);
		...
		btnAadir.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnAadir.setIcon(new ImageIcon(ArtefactosNPC.class
			...
			public void actionPerformed(ActionEvent e) {
				if (ppos >= 0) {
					...
					if (comboBox.getSelectedIndex() == 1) {
						if (EquipoNPC.getTextField_12().getText().equals("")) {
							...
							if (cont == 0) {
								int cont2 = 0;
								try {
									poss.CalculoPosesion(StartNPC.character);
								...
								if (app == 1) {
									...
									JOptionPane
											.showMessageDialog(
													...
													"",
													JOptionPane.ERROR_MESSAGE);
									EquipoNPC.armor1 = new Armor("", "", false,false,
											null);
								}
								if (exp == 1) {
									exp = 0;
					...
					if (comboBox.getSelectedIndex() == 2) {
						...
						if (ArmasNPC.tipow.equals("Una Mano")) {
							OneHanded arma = new OneHanded(textField.getText(),
									textArea.getText(),
									false,true, poss,comboBox_4.getSelectedItem().toString());
							if (EquipoNPC.getTextField().getText().equals("")
									&& EquipoNPC.pweap >= 1) {
								added = 1;
								EquipoNPC.weapon1 = arma;
								EquipoNPC.weapon1.setPossesion(poss);	
								EquipoNPC.getTextField().setText(
										EquipoNPC.weapon1.getWeapon());
							} else {
								if (EquipoNPC.getTextField_1().getText()
										.equals("")
										&& EquipoNPC.pweap >= 2) {
									added = 2;
									EquipoNPC.weapon2 = arma;
									EquipoNPC.weapon2.setPossesion(poss);
									EquipoNPC.getTextField_1().setText(
											EquipoNPC.weapon2.getWeapon());
								} else {
									if (EquipoNPC.getTextField_2().getText()
											.equals("")
											&& EquipoNPC.pweap >= 3) {
										added = 3;
										EquipoNPC.weapon3 = arma;
										EquipoNPC.weapon3.setPossesion(poss);
										EquipoNPC.getTextField_2().setText(
												EquipoNPC.weapon3.getWeapon());
									} else {
										if (EquipoNPC.getTextField_3().getText()
												.equals("")
												&& EquipoNPC.pweap >= 4) {
											added = 4;
											EquipoNPC.weapon4 = arma;
											EquipoNPC.weapon4.setPossesion(poss);
											EquipoNPC.getTextField_3().setText(
													EquipoNPC.weapon4.getWeapon());
										} else {
											added = 0;
											JOptionPane
													.showMessageDialog(
						...
						if (ArmasNPC.tipow.equals("Dos Manos")) {
							
							if(comboBox_4.getSelectedItem().toString().equals("Espadón") && StartNPC.character.getAtributes().getStrength()<10){
							...
							else if(comboBox_4.getSelectedItem().toString().equals("Hacha de Guerra") && StartNPC.character.getAtributes().getStrength()<10){
							...
							else if(comboBox_4.getSelectedItem().toString().equals("Martillo de Guerra") && StartNPC.character.getAtributes().getStrength()<12){
							...
							else if(comboBox_4.getSelectedItem().toString().equals("Ultra-Espadón") && StartNPC.character.getAtributes().getStrength()<15){
							...
							TwoHanded arma = new TwoHanded(textField.getText(),
									textArea.getText(),false,true, poss,comboBox_4.getSelectedItem().toString());
							if (EquipoNPC.getTextField().getText().equals("")
									&& EquipoNPC.pweap >= 1) {
								added = 1;
								EquipoNPC.weapon1 = arma;
						...
						if (ArmasNPC.tipow.equals("De Asta")) {
						...
						if (ArmasNPC.tipow.equals("A Distancia")) {
							if(comboBox_4.getSelectedItem().toString().equals("Arma de Fuego") && StartNPC.character.getKnowledgeSkills().getSecretKnowledge()<2){
						...
						int cont1 = 0;
						if (ArmasNPC.tipow.equals("Escudo")) {
						...
						if (cont1 == 0 && cont == 0) {
							...
							if (app == 1) {
								...
								cont2 = 1;
								if (added == 1) {
									EquipoNPC.weapon1 = new Weapons("", "",
											false,false, null,"");
									EquipoNPC.getTextField().setText("");
								}
								if (added == 2) {
									EquipoNPC.weapon2 = new Weapons("", "",
											false,false, null,"");
									EquipoNPC.getTextField_1().setText("");
								}
								if (added == 3) {
									EquipoNPC.weapon3 = new Weapons("", "",
											false,false, null,"");
									EquipoNPC.getTextField_2().setText("");
								}
								if (added == 4) {
									EquipoNPC.weapon4 = new Weapons("", "",
											false,false, null,"");
									EquipoNPC.getTextField_3().setText("");
								}
								JOptionPane
							...
							if (masp == 1) {
								...
								if (added == 4) {
									EquipoNPC.weapon4 = new Weapons("","",false,false, null,"");
									EquipoNPC.getTextField_3().setText("");
								}
								JOptionPane
										.showMessageDialog(
					...
					if (comboBox.getSelectedIndex() == 3) {
						...
						if (EquipoNPC.getTextField_4().getText().equals("")
							...
							if (EquipoNPC.getTextField_5().getText().equals("")
								...
								if (EquipoNPC.getTextField_6().getText()
										.equals("")
										&& EquipoNPC.pmisc >= 3) {
									added = 3;
									...
									if (EquipoNPC.getTextField_7().getText()
											.equals("")
											&& EquipoNPC.pmisc >= 4) {
										added = 4;
						...
						if (cont == 0) {
							...
							if (app == 1) {
								...
								cont2 = 1;
								if (added == 1) {
									EquipoNPC.misc1 = new Misc("", "", false,
											false,null);
									EquipoNPC.getTextField_4().setText("");
								}
								if (added == 2) {
									EquipoNPC.misc2 = new Misc("", "", false,false,
											null);
									EquipoNPC.getTextField_5().setText("");
								}
								if (added == 3) {
									EquipoNPC.misc3 = new Misc("", "", false,false,
											null);
									EquipoNPC.getTextField_6().setText("");
								}
								if (added == 4) {
									EquipoNPC.misc4 = new Misc("", "", false,false,
											null);
									EquipoNPC.getTextField_7().setText("");
								}
								JOptionPane
							...
							if (exp == 1) {
								...
								cont2 = 1;
								if (added == 1) {
									EquipoNPC.misc1 = new Misc("", "", false,false,
											null);
									EquipoNPC.getTextField_4().setText("");
								}
								if (added == 2) {
					...
					if (comboBox.getSelectedIndex() == 4) {
						...
						if (tipoac.equals("Capa")) {
							Cloak acc = new Cloak(textField.getText(), textArea
									.getText(), false,true, poss);
							if (EquipoNPC.getTextField_8().getText().equals("")) {
								added = 1;
								EquipoNPC.accesories1 = acc;
								EquipoNPC.getTextField_8().setText(
										EquipoNPC.accesories1.getAccesory());
							} else {
								if (EquipoNPC.getTextField_9().getText()
										.equals("")) {
									added = 2;
									EquipoNPC.accesories2 = acc;
									EquipoNPC.getTextField_9()
											.setText(
													EquipoNPC.accesories2
															.getAccesory());
								} else {
									if (EquipoNPC.getTextField_10().getText()
											.equals("")) {
										added = 3;
										EquipoNPC.accesories3 = acc;
										EquipoNPC.getTextField_10().setText(
												EquipoNPC.accesories3
														.getAccesory());
									} else {
										if (EquipoNPC.getTextField_11()
												.getText().equals("")) {
											added = 4;
											EquipoNPC.accesories4 = acc;
											EquipoNPC
													.getTextField_11()
													.setText(
															EquipoNPC.accesories4
																	.getAccesory());
										} else {
											added = 0;
											JOptionPane
						...
						if (cont == 0) {
							...
							if (app == 1) {
								...
								cont2 = 1;
								if (added == 1) {
									EquipoNPC.accesories1 = new Accesories("",
											"", false,false, null);
									EquipoNPC.getTextField_8().setText("");
								}
								if (added == 2) {
									EquipoNPC.accesories2 = new Accesories("",
											"", false,false, null);
									EquipoNPC.getTextField_9().setText("");
								}
								if (added == 3) {
									EquipoNPC.accesories3 = new Accesories("",
											"", false,false, null);
									EquipoNPC.getTextField_10().setText("");
								}
								if (added == 4) {
									EquipoNPC.accesories4 = new Accesories("",
											"", false,false, null);
									EquipoNPC.getTextField_11().setText("");
								}
								JOptionPane
										.showMessageDialog(
												frame.getContentPane(),
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				btnVolver.setIcon(new ImageIcon(ArtefactosNPC.class
		...
		chckbxArmaduraLigera.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (chckbxArmaduraLigera.isSelected() == true) {
					ArtefactosNPC.tipoarm = "Armadura Ligera";
					chckbxUnaMano.setEnabled(false);
					chckbxColgante.setEnabled(false);
					chckbxPendiente.setEnabled(false);
					chckbxCapa.setEnabled(false);
		...
		chckbxArmaduraPesada.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (chckbxArmaduraPesada.isSelected() == true) {
					ArtefactosNPC.tipoarm = "Armadura Pesada";
					chckbxUnaMano.setEnabled(false);
					chckbxColgante.setEnabled(false);
					chckbxPendiente.setEnabled(false);
					chckbxCapa.setEnabled(false);
		...
		txtPropiedadesPosesin.setText("Propiedades de Artefacto:");
		...
		button_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_3.setIcon(new ImageIcon(ArtefactosNPC.class
		...
		button_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_4.setIcon(new ImageIcon(ArtefactosNPC.class
						.getResource("/images/boton +-2.png")));
		...
		comboBox_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (comboBox_1.getSelectedIndex() == 43) {
					ppos += ppos1;
...
if(comboBox_2.getSelectedIndex()== 42){
		...
		button_2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				button_2.setIcon(new ImageIcon(ArtefactosNPC.class
						.getResource("/images/boton +-2.png")));
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_1.setIcon(new ImageIcon(ArtefactosNPC.class
						.getResource("/images/boton +-2.png")));
		...
		label.setIcon(new ImageIcon(ArtefactosNPC.class
