	...
	private void initialize() {
		...
		frame.getContentPane().setLayout(null);
		{
			...
			frame.getContentPane().add(tabbedPane);
			{
				...
				tabbedPane.addTab(EquipoNPC.weapon1.getWeapon(), panel);
				...
				textArea.setText(EquipoNPC.weapon1.getDescription());
				...
				if (EquipoNPC.weapon1.isPosesion() == true ||EquipoNPC.weapon1.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.weapon1.getPossesion()
							.getPos();
				...
				textField.setText(EquipoNPC.weapon1.getWeapon());
				...
				panel.add(textField);
				if (EquipoNPC.weapon1.getClass().getSimpleName()
						.equals("OneHanded")) {
				...
				if (EquipoNPC.weapon1.getClass().getSimpleName().equals("Pole")) {
					textField.setText("Arma de asta");
				}
				if (EquipoNPC.weapon1.getClass().getSimpleName()
						.equals("Ranged")) {
					textField.setText("Arma a Distancia");
					txtesArrojadiza.setText("¿Es de Fuego?");
				}
				if (EquipoNPC.weapon1.getClass().getSimpleName()
						.equals("Shields")) {
				...
				button.setIcon(new ImageIcon(ResumenArmasNPC.class
				...
				textField_3.setText(EquipoNPC.weapon1.getTipo());
				...
				if (EquipoNPC.weapon1.isPosesion() == true) {
				...
				label.setIcon(new ImageIcon(ResumenArmasNPC.class
			...
			tabbedPane.addTab(EquipoNPC.weapon2.getWeapon(), null, panel_1,
					null);
			...
			{
				{
					...
					textArea.setWrapStyleWord(true);
					textArea.setLineWrap(true);
					textArea.setText(EquipoNPC.weapon2.getDescription());
					textArea.setEditable(false);
					scrollPane.setViewportView(textArea);
					...
					textArea_1.setWrapStyleWord(true);
					textArea_1.setLineWrap(true);
					if (EquipoNPC.weapon2.isPosesion() == true ||EquipoNPC.weapon2.isLegendaria() == true) {

						ArrayList<String> pos = EquipoNPC.weapon2
								.getPossesion().getPos();
						for (int i = 0; i < pos.size(); i++) {
							if (pos.get(i) != ("-Propiedad-")) {
								textArea_1.append(pos.get(i) + "\n");
					...
					textField = new JTextField();
					textField.setText(EquipoNPC.weapon2.getWeapon());
					...
					if (EquipoNPC.weapon2.getClass().getSimpleName()
							.equals("OneHanded")) {
						textField.setText("Arma de una mano");
					}
					if (EquipoNPC.weapon2.getClass().getSimpleName()
					...
					textField_3 = new JTextField();
					textField_3.setText(EquipoNPC.weapon2.getTipo());
					textField_3.setFont(mf.MyFont(0, 11));
					textField_3.setEditable(false);
					textField_3.setColumns(10);
					textField_3.setBackground(Color.WHITE);
					...
					if (EquipoNPC.weapon2.isPosesion() == true) {
						textField_4.setText("Posesión");
					}
			...
			tabbedPane.addTab(EquipoNPC.weapon3.getWeapon(), null, panel_2,
					null);
			panel_2.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.weapon3.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.weapon3.isPosesion() == true ||EquipoNPC.weapon3.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.weapon3.getPossesion()
							.getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				textField = new JTextField();
				textField.setText(EquipoNPC.weapon3.getWeapon());
				textField.setFont(mf.MyFont(0, 11));
				textField.setEditable(false);
				textField.setColumns(10);
				textField.setBackground(Color.WHITE);
				...
				if (EquipoNPC.weapon3.getClass().getSimpleName()
						.equals("OneHanded")) {
					textField.setText("Arma de una mano");
				}
				if (EquipoNPC.weapon3.getClass().getSimpleName()
				...
				if (EquipoNPC.weapon3.getClass().getSimpleName().equals("Pole")) {
					textField.setText("Arma de asta");
				}
				if (EquipoNPC.weapon3.getClass().getSimpleName()
						.equals("Ranged")) {
				...
				textField_3 = new JTextField();
				textField_3.setText(EquipoNPC.weapon3.getTipo());
				textField_3.setFont(mf.MyFont(0, 11));
				textField_3.setEditable(false);
				textField_3.setColumns(10);
				textField_3.setBackground(Color.WHITE);
				...
				if (EquipoNPC.weapon3.isPosesion() == true) {
					textField_4.setText("Posesión");
				}
			...
			tabbedPane.addTab(EquipoNPC.weapon4.getWeapon(), null, panel_3,
					null);
			panel_3.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.weapon4.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.weapon4.isPosesion() == true ||EquipoNPC.weapon4.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.weapon4.getPossesion()
							.getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				textField = new JTextField();
				textField.setText(EquipoNPC.weapon4.getWeapon());
				textField.setFont(mf.MyFont(0, 11));
				textField.setEditable(false);
				textField.setColumns(10);
				textField.setBackground(Color.WHITE);
				...
				if (EquipoNPC.weapon4.getClass().getSimpleName()
						.equals("OneHanded")) {
					textField.setText("Arma de una mano");
				}
				if (EquipoNPC.weapon4.getClass().getSimpleName()
				...
				if (EquipoNPC.weapon4.getClass().getSimpleName().equals("Pole")) {
					textField.setText("Arma de asta");
				}
				if (EquipoNPC.weapon4.getClass().getSimpleName()
						.equals("Ranged")) {
				...
				textField_3 = new JTextField();
				textField_3.setText(EquipoNPC.weapon4.getTipo());
				textField_3.setFont(mf.MyFont(0, 11));
				textField_3.setEditable(false);
				textField_3.setColumns(10);
				textField_3.setBackground(Color.WHITE);
				...
				if (EquipoNPC.weapon4.isPosesion() == true) {
					textField_4.setText("Posesión");
				}
		...
		lblNewLabel.setIcon(new ImageIcon(ResumenArmasNPC.class
