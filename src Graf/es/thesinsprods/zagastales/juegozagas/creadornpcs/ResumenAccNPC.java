	...
	private void initialize() {
		...
		frame.getContentPane().setLayout(null);
		{
			...
			frame.getContentPane().add(tabbedPane);
			{
				...
				tabbedPane.addTab(EquipoNPC.accesories1.getAccesory(), panel);
				...
				textArea.setText(EquipoNPC.accesories1.getDescription());
				...
				if (EquipoNPC.accesories1.isPosesion() == true ||EquipoNPC.accesories1.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.accesories1
							.getPossesion().getPos();
				...
				panel.add(textField);
				if (EquipoNPC.accesories1.getClass().getSimpleName()
						.equals("Cloak")) {
				...
				button.setIcon(new ImageIcon(ResumenAccNPC.class
				...
				if (EquipoNPC.accesories1.isPosesion() == true) {
				...
				label.setIcon(new ImageIcon(ResumenAccNPC.class
			...
			tabbedPane.addTab(EquipoNPC.accesories2.getAccesory(), null,
					panel_1, null);
			...
			{
				{
					...
					textArea.setWrapStyleWord(true);
					textArea.setLineWrap(true);
					textArea.setText(EquipoNPC.accesories2.getDescription());
					textArea.setEditable(false);
					scrollPane.setViewportView(textArea);
					...
					textArea_1.setWrapStyleWord(true);
					textArea_1.setLineWrap(true);
					if (EquipoNPC.accesories2.isPosesion() == true ||EquipoNPC.accesories2.isLegendaria() == true) {

						ArrayList<String> pos = EquipoNPC.accesories2
								.getPossesion().getPos();
						for (int i = 0; i < pos.size(); i++) {
							if (pos.get(i) != ("-Propiedad-")) {
								textArea_1.append(pos.get(i) + "\n");
					...
					if (EquipoNPC.accesories2.getClass().getSimpleName()
							.equals("Cloak")) {
						textField.setText("Capa");
					}
					if (EquipoNPC.accesories2.getClass().getSimpleName()
					...
					if (EquipoNPC.accesories2.isPosesion() == true) {
						textField_4.setText("Posesión");
					}
			...
			tabbedPane.addTab(EquipoNPC.accesories3.getAccesory(), null,
					panel_2, null);
			panel_2.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.accesories3.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.accesories3.isPosesion() == true ||EquipoNPC.accesories3.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.accesories3
							.getPossesion().getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				if (EquipoNPC.accesories3.getClass().getSimpleName()
						.equals("Cloak")) {
					textField.setText("Capa");
				}
				if (EquipoNPC.accesories3.getClass().getSimpleName()
				...
				if (EquipoNPC.accesories3.isPosesion() == true) {
					textField_4.setText("Posesión");
				}
			...
			tabbedPane.addTab(EquipoNPC.accesories4.getAccesory(), null,
					panel_3, null);
			panel_3.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.accesories4.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.accesories4.isPosesion() == true ||EquipoNPC.accesories4.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.accesories4
							.getPossesion().getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				if (EquipoNPC.accesories4.getClass().getSimpleName()
						.equals("Cloak")) {
					textField.setText("Capa");
				}
				if (EquipoNPC.accesories4.getClass().getSimpleName()
				...
				if (EquipoNPC.accesories4.isPosesion() == true) {
					textField_4.setText("Posesión");
				}
		...
		lblNewLabel.setIcon(new ImageIcon(ResumenAccNPC.class
