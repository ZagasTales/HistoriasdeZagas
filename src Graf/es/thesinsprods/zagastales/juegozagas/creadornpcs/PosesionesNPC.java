...
public class PosesionesNPC {
	...
	private void initialize() {
		...
		textField_1.setText("" + StartNPC.contadorPosesion);
					...
					if (comboBox.getSelectedIndex() == 3) {
						...
						if (cont == 0) {
							...
							if (app == 1) {
								...
								cont2 = 1;
								if (added == 1) {
									EquipoNPC.misc1 = new Misc("", "", false,false, null);
									EquipoNPC.getTextField_4().setText("");
								}
								if (added == 2) {
									EquipoNPC.misc2 = new Misc("", "", false,false, null);
									EquipoNPC.getTextField_5().setText("");
								}
								if (added == 3) {
									EquipoNPC.misc3 = new Misc("", "", false,false, null);
									EquipoNPC.getTextField_6().setText("");
								}
								if (added == 4) {
									EquipoNPC.misc4 = new Misc("", "", false,false, null);
									EquipoNPC.getTextField_7().setText("");
								}
								JOptionPane
										.showMessageDialog(
							...
							if (EquipoNPC.getTextField_8().getText().equals("")) {
								...
								if (EquipoNPC.getTextField_9().getText()
									...
									EquipoNPC.getTextField_9().setText(
											EquipoNPC.accesories2.getAccesory());
								} else {
									if (EquipoNPC.getTextField_10().getText()
										...
										if (EquipoNPC.getTextField_11().getText()
												.equals("")) {
											added = 4;
		...
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"-Propiedad-", "+1 Fuerza", "+1 Destreza", "+1 Resistencia", "+1 Resistencia M\u00E1gica", "+1 Inteligencia", "+1 Percepci\u00F3n", "+1 Carisma", "+1 ArmasNPC de Una Mano", "+1 ArmasNPC de Dos Manos", "+1 ArmasNPC de Asta", "+1 ArmasNPC a Distancia", "+1 Esquivar", "+1 Bloquear", "+1 Arte de la Guerra", "+1 Diplomacia", "+1 Etiqueta", "+1 Medicina", "+1 Ocultismo", "+1 Investigacion", "+1 Negociaci\u00F3n", "+1 Conocimientos Secretos", "+1 Magia Fuego", "+1 Magia Agua", "+1 Magia Tierra", "+1 Magia Viento", "+1 Magia Blanca", "+1 Magia Negra", "+1 Magia Druidica", "+1 Magia Arcana", "+1 Atletismo", "+1 Supervivencia", "+1 Equitaci\u00F3n", "+1 Trampas", "+1 Sigilo", "Da\u00F1o Elemental de Fuego", "Da\u00F1o Elemental de Agua", "Da\u00F1o Elemental de Tierra", "Da\u00F1o Elemental de Viento", "Da\u00F1o Elemental Arcano", "Da\u00F1o Elemental Oscuro", "Da\u00F1o Elemental Sagrado", "+3 Salud", "+5 Energ\u00EDa", "+5 Man\u00E1"}));
		...
		comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"-Propiedad-", "+1 Fuerza", "+1 Destreza", "+1 Resistencia", "+1 Resistencia M\u00E1gica", "+1 Inteligencia", "+1 Percepci\u00F3n", "+1 Carisma", "+1 ArmasNPC de Una Mano", "+1 ArmasNPC de Dos Manos", "+1 ArmasNPC de Asta", "+1 ArmasNPC a Distancia", "+1 Esquivar", "+1 Bloquear", "+1 Arte de la Guerra", "+1 Diplomacia", "+1 Etiqueta", "+1 Medicina", "+1 Ocultismo", "+1 Investigacion", "+1 Negociaci\u00F3n", "+1 Conocimientos Secretos", "+1 Magia Fuego", "+1 Magia Agua", "+1 Magia Tierra", "+1 Magia Viento", "+1 Magia Blanca", "+1 Magia Negra", "+1 Magia Druidica", "+1 Magia Arcana", "+1 Atletismo", "+1 Supervivencia", "+1 Equitaci\u00F3n", "+1 Trampas", "+1 Sigilo", "Da\u00F1o Elemental de Fuego", "Da\u00F1o Elemental de Agua", "Da\u00F1o Elemental de Tierra", "Da\u00F1o Elemental de Viento", "Da\u00F1o Elemental Arcano", "Da\u00F1o Elemental Oscuro", "Da\u00F1o Elemental Sagrado", "+3 Salud", "+5 Energ\u00EDa", "+5 Man\u00E1"}));
