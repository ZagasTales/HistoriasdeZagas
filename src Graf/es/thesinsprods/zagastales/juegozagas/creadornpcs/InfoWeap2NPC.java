...
public class InfoWeap2NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.weapon2.isPosesion() == true ||EquipoNPC.weapon2.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.weapon2.getPossesion().getPos();
		...
		txtesArrojadiza.setText(EquipoNPC.weapon2.getTipo());
		...
		if (EquipoNPC.weapon2.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (EquipoNPC.weapon2.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (EquipoNPC.weapon2.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (EquipoNPC.weapon2.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (EquipoNPC.weapon2.getClass().getSimpleName().equals("Shields")) {
