...
public class InfoAcc2NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.accesories2.isPosesion() == true || EquipoNPC.accesories2.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.accesories2.getPossesion()
					.getPos();
		...
		if (EquipoNPC.accesories2.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (EquipoNPC.accesories2.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (EquipoNPC.accesories2.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (EquipoNPC.accesories2.getClass().getSimpleName().equals("Rings")) {
