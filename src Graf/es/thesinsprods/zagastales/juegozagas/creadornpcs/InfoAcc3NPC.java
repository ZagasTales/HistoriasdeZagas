...
public class InfoAcc3NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.accesories3.isPosesion() == true || EquipoNPC.accesories3.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.accesories3.getPossesion()
					.getPos();
		...
		if (EquipoNPC.accesories3.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (EquipoNPC.accesories3.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (EquipoNPC.accesories3.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (EquipoNPC.accesories3.getClass().getSimpleName().equals("Rings")) {
