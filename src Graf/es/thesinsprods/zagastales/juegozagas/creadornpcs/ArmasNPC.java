			...
			public void actionPerformed(ActionEvent e) {
				...
				if (tipow.equals("Una Mano")) {
					OneHanded arma = new OneHanded(textField.getText(),
							...
							EquipoNPC.posss,comboBox.getSelectedItem().toString());
					if (EquipoNPC.getTextField().getText().equals("")
						...
						if (EquipoNPC.getTextField_1().getText().equals("")
								&& EquipoNPC.pweap >= 2) {
							EquipoNPC.weapon2 = arma;
							EquipoNPC.getTextField_1().setText(
									EquipoNPC.weapon2.getWeapon());
						} else {
							if (EquipoNPC.getTextField_2().getText().equals("")
									&& EquipoNPC.pweap >= 3) {
