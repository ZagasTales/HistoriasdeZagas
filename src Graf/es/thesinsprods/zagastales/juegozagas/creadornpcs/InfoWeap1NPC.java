...
public class InfoWeap1NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.weapon1.isPosesion() == true ||EquipoNPC.weapon1.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.weapon1.getPossesion().getPos();
		...
		txtesArrojadiza.setText(EquipoNPC.weapon1.getTipo());
		...
		if (EquipoNPC.weapon1.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (EquipoNPC.weapon1.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (EquipoNPC.weapon1.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (EquipoNPC.weapon1.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (EquipoNPC.weapon1.getClass().getSimpleName().equals("Shields")) {
