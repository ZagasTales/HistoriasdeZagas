...
public class CombateNPC {
	...
	private void initialize() {
		...
		textField_2
				.setText("" + StartNPC.character.getCombatSkills().getPole());
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				button.setIcon(new ImageIcon(CombateNPC.class
		...
		button_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_1.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_2.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_3.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_4.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_5.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_5.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_6.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_6.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_7.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_7.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_8.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_8.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_9.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_9.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_10.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_10.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		button_11.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button_11.setIcon(new ImageIcon(CombateNPC.class
						.getResource("/images/boton +-2.png")));
			}
		...
		if (StartNPC.character.getCombatSkills().getOneHanded() == minUna) {
			button_6.setEnabled(false);
		}
		if (StartNPC.character.getCombatSkills().getTwoHanded() == minDos) {
			button_7.setEnabled(false);
		}
		if (StartNPC.character.getCombatSkills().getPole() == minAsta) {
			button_8.setEnabled(false);
		}
		if (StartNPC.character.getCombatSkills().getRanged() == minDist) {
			button_9.setEnabled(false);
		}
		if (StartNPC.character.getCombatSkills().getDodge() == minEsq) {
			button_10.setEnabled(false);
		}
		if (StartNPC.character.getCombatSkills().getBlock() == minBloq) {
				...
				try {
					if (StartNPC.character.getCombatSkills().getOneHanded() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills().setOneHanded(
					...
					if (StartNPC.character.getCombatSkills().getOneHanded() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (StartNPC.character.getCombatSkills().getTwoHanded() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills().setTwoHanded(
								StartNPC.character.getCombatSkills()
										.getTwoHanded() + 1);
						textField_1.setText(""
								+ StartNPC.character.getCombatSkills()
					...
					if (StartNPC.character.getCombatSkills().getTwoHanded() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getTwoHanded() == 2
							&& StartNPC.character.getSetbacks().Search(
									"Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (StartNPC.character.getCombatSkills().getPole() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills()
								.setPole(
					...
					if (StartNPC.character.getCombatSkills().getPole() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getPole() == 2
							&& StartNPC.character.getSetbacks().Search(
									"Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getPole() < 3
						...
						if (StartNPC.character.getCombatSkills().getPole() < 2) {
							StartNPC.character.getCombatSkills().setPole(
									StartNPC.character.getCombatSkills()
											.getPole() + 1);
							textField_2.setText(""
									+ StartNPC.character.getCombatSkills()
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (StartNPC.character.getCombatSkills().getRanged() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills().setRanged(
								StartNPC.character.getCombatSkills()
										.getRanged() + 1);
						textField_3.setText(""
								+ StartNPC.character.getCombatSkills()
					...
					if (StartNPC.character.getCombatSkills().getRanged() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getRanged() == 2
							&& StartNPC.character.getSetbacks().Search(
									"Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (StartNPC.character.getCombatSkills().getDodge() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills()
								.setDodge(
					...
					if (StartNPC.character.getCombatSkills().getDodge() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getDodge() == 2
							&& StartNPC.character.getSetbacks().Search(
									"Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getDodge() < 3
						...
						if (StartNPC.character.getCombatSkills().getDodge() < 2) {
							StartNPC.character.getCombatSkills().setDodge(
									StartNPC.character.getCombatSkills()
											.getDodge() + 1);
							textField_4.setText(""
									+ StartNPC.character.getCombatSkills()
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (StartNPC.character.getCombatSkills().getBlock() == 4
							&& StartNPC.character.getPrivileges().Search(
									"Maestro")) {
						StartNPC.character.getCombatSkills()
								.setBlock(
					...
					if (StartNPC.character.getCombatSkills().getBlock() == 3
							&& StartNPC.character.getPrivileges().Search(
									"Experto") == false) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getBlock() == 2
							&& StartNPC.character.getSetbacks().Search(
									"Aprendiz") == true) {
						JOptionPane
								.showMessageDialog(
					...
					if (StartNPC.character.getCombatSkills().getBlock() < 3
						...
						if (StartNPC.character.getCombatSkills().getBlock() < 2) {
							StartNPC.character.getCombatSkills().setBlock(
									StartNPC.character.getCombatSkills()
											.getBlock() + 1);
							textField_5.setText(""
									+ StartNPC.character.getCombatSkills()
		...
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					StartNPC.character.getCombatSkills().setPole(
							StartNPC.character.getCombatSkills().getPole() - 1);
					textField_2.setText(""
							+ StartNPC.character.getCombatSkills().getPole());
		...
		btnVolverAHabilidades.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				btnVolverAHabilidades.setIcon(new ImageIcon(CombateNPC.class
		...
		lblNewLabel.setIcon(new ImageIcon(CombateNPC.class
