...
public class InfoWeap3NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.weapon3.isPosesion() == true ||EquipoNPC.weapon3.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.weapon3.getPossesion().getPos();
		...
		txtesArrojadiza.setText(EquipoNPC.weapon3.getTipo());
		...
		if (EquipoNPC.weapon3.getClass().getSimpleName().equals("OneHanded")) {
			textField.setText("Arma de una mano");
		}
		if (EquipoNPC.weapon3.getClass().getSimpleName().equals("TwoHanded")) {
			textField.setText("Arma de dos manos");
		}
		if (EquipoNPC.weapon3.getClass().getSimpleName().equals("Pole")) {
			textField.setText("Arma de asta");
		}
		if (EquipoNPC.weapon3.getClass().getSimpleName().equals("Ranged")) {
			textField.setText("Arma a Distancia");
		}
		if (EquipoNPC.weapon3.getClass().getSimpleName().equals("Shields")) {
