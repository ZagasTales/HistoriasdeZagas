	...
	private void initialize() {
		...
		frame.getContentPane().setLayout(null);
		{
			...
			frame.getContentPane().add(tabbedPane);
			{
				...
				tabbedPane.addTab(EquipoNPC.misc1.getMisc(), panel);
				...
				textArea.setText(EquipoNPC.misc1.getDescription());
				...
				if (EquipoNPC.misc1.isPosesion() == true ||EquipoNPC.misc1.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.misc1.getPossesion()
							.getPos();
				...
				button.setIcon(new ImageIcon(ResumenMiscNPC.class
				...
				if (EquipoNPC.misc1.isPosesion() == true) {
				...
				label.setIcon(new ImageIcon(ResumenMiscNPC.class
			...
			tabbedPane.addTab(EquipoNPC.misc2.getMisc(), null, panel_1, null);
			panel_1.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.misc2.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.misc2.isPosesion() == true ||EquipoNPC.misc2.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.misc2.getPossesion()
							.getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				if (EquipoNPC.misc2.isPosesion() == true) {
					textField.setText("Posesión");
				}
			...
			tabbedPane.addTab(EquipoNPC.misc3.getMisc(), null, panel_2, null);
			panel_2.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.misc3.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.misc3.isPosesion() == true ||EquipoNPC.misc3.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.misc3.getPossesion()
							.getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				if (EquipoNPC.misc3.isPosesion() == true) {
					textField.setText("Posesión");
				}
			...
			tabbedPane.addTab(EquipoNPC.misc4.getMisc(), null, panel_3, null);
			panel_3.setLayout(null);
			{
				...
				textArea.setWrapStyleWord(true);
				textArea.setLineWrap(true);
				textArea.setText(EquipoNPC.misc4.getDescription());
				textArea.setEditable(false);
				scrollPane.setViewportView(textArea);
				...
				textArea_1.setWrapStyleWord(true);
				textArea_1.setLineWrap(true);
				if (EquipoNPC.misc4.isPosesion() == true ||EquipoNPC.misc4.isLegendaria() == true) {

					ArrayList<String> pos = EquipoNPC.misc4.getPossesion()
							.getPos();
					for (int i = 0; i < pos.size(); i++) {
						if (pos.get(i) != ("-Propiedad-")) {
							textArea_1.append(pos.get(i) + "\n");
				...
				if (EquipoNPC.misc4.isPosesion() == true) {
					textField.setText("Posesión");
				}
		...
		lblNewLabel.setIcon(new ImageIcon(ResumenMiscNPC.class
