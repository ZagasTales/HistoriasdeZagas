...
public class InfoArm1NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.armor1.isPosesion() == true ||EquipoNPC.armor1.isLegendaria() == true) {

			ArrayList<String> pos = EquipoNPC.armor1.getPossesion().getPos();
		...
		textField.setText(EquipoNPC.armor1.getArmor());
		textArea.setText(EquipoNPC.armor1.getDescription());
		...
		if (EquipoNPC.armor1.isPosesion() == true) {
