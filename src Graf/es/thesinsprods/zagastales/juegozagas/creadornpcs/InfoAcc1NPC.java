...
public class InfoAcc1NPC {
	...
	private void initialize() {
		...
		if (EquipoNPC.accesories1.isPosesion() == true || EquipoNPC.accesories1.isLegendaria() == true) {
			...
			ArrayList<String> pos = EquipoNPC.accesories1.getPossesion()
					.getPos();
		...
		if (EquipoNPC.accesories1.getClass().getSimpleName().equals("Cloak")) {
			textField.setText("Capa");
		}
		if (EquipoNPC.accesories1.getClass().getSimpleName().equals("Earrings")) {
			textField.setText("Pendientes");
		}
		if (EquipoNPC.accesories1.getClass().getSimpleName().equals("Necklace")) {
			textField.setText("Colgante");
		}
		if (EquipoNPC.accesories1.getClass().getSimpleName().equals("Rings")) {
