...
public class InfoArmaduraCargar {
	...
	private void initialize() {
		...
		if (CargarPersonaje.posesionArm.equals("Si")) {

			textArea_1.append(CargarPersonaje.prop1Arm + "\n");
			textArea_1.append(CargarPersonaje.prop2Arm + "\n");
			textArea_1.append(CargarPersonaje.prop3Arm + "\n");
		...
		textField.setText(CargarPersonaje.armadura);
		...
		textArea.setText(CargarPersonaje.descripcionArm);
		...
		textField_4.setText(CargarPersonaje.posesionArm);
