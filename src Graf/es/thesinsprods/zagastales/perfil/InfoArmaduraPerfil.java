...
public class InfoArmaduraPerfil {
	...
	private void initialize() {
		...
		if (DatosPersonaje.posesionArm.equals("Si")) {

			textArea_1.append(DatosPersonaje.prop1Arm + "\n");
			textArea_1.append(DatosPersonaje.prop2Arm + "\n");
			textArea_1.append(DatosPersonaje.prop3Arm + "\n");
		...
		textField.setText(DatosPersonaje.armadura);
		...
		textArea.setText(DatosPersonaje.descripcionArm);
		...
		textField_4.setText(DatosPersonaje.posesionArm);
