...
public class InfoExtrasCargar {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(InfoExtrasCargar.class.getResource("/images/Historias de Zagas, logo.png")));
		...
		frame.getContentPane().setLayout(null);
		{
			...
			button.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoExtrasCargar.class.getResource("/images/boton atras2.png")));
				}
				@Override
				public void mouseReleased(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoExtrasCargar.class.getResource("/images/boton atras.png")));
				}
			});
		...
		textArea.setText(CargarPersonaje.extras);
