...
public class InfoPoderes {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(InfoPoderes.class.getResource("/images/Historias de Zagas, logo.png")));
		...
		frame.getContentPane().setLayout(null);
		{
			...
			button.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoPoderes.class.getResource("/images/boton atras2.png")));
				}
				@Override
				public void mouseReleased(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoPoderes.class.getResource("/images/boton atras.png")));
				}
			});
		...
		textArea.setText(DatosPersonaje.poderes);
		...
		label.setIcon(new ImageIcon(InfoPoderes.class.getResource("/images/background-panteon.jpg")));
