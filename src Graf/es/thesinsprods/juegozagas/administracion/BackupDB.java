	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				btnNewButton.setIcon(new ImageIcon(BackupDB.class
		...
		button.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				button.setIcon(new ImageIcon(BackupDB.class
						.getResource("/images/boton datos2.png")));
		...
		final JButton btnNewButton_1 = new JButton("Crear Copia");
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				btnNewButton_1.setIcon(new ImageIcon(BackupDB.class
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					int seleccion = JOptionPane
							.showOptionDialog(
									null,
									"Para realizar una copia de seguridad debe de cerrar el programa.¿Desea continuar?.",
					...
					if (JOptionPane.YES_OPTION == seleccion) {
						...
						Process p = Runtime.getRuntime().exec(
								"cmd /C exp ZAGASROOT/putospk2 file="
										+ textField.getText()
										+ ".dmp full=y log="
										+ textField_1.getText() + ".log");
						System.exit(0);
					}
		...
		btnVolver.setIcon(new ImageIcon(BackupDB.class
				.getResource("/images/boton atras.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(BackupDB.class
