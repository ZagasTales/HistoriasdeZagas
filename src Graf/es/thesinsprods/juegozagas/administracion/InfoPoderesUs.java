...
public class InfoPoderesUs {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(InfoPoderesUs.class.getResource("/images/Historias de Zagas, logo.png")));
		...
		frame.getContentPane().setLayout(null);
		{
			...
			button.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoPoderesUs.class.getResource("/images/boton atras2.png")));
				}
				@Override
				public void mouseReleased(MouseEvent e) {
					button.setIcon(new ImageIcon(InfoPoderesUs.class.getResource("/images/boton atras.png")));
				}
			});
		...
		label.setIcon(new ImageIcon(InfoPoderesUs.class.getResource("/images/background-panteon.jpg")));
