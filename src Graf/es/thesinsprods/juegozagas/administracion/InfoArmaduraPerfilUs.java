...
public class InfoArmaduraPerfilUs {
	...
	private void initialize() {
		...
		if (DatosPersonajesUsuario.posesionArm.equals("Si")) {

			textArea_1.append(DatosPersonajesUsuario.prop1Arm + "\n");
			textArea_1.append(DatosPersonajesUsuario.prop2Arm + "\n");
			textArea_1.append(DatosPersonajesUsuario.prop3Arm + "\n");
		...
		textField.setText(DatosPersonajesUsuario.armadura);
		...
		textArea.setText(DatosPersonajesUsuario.descripcionArm);
		...
		textField_4.setText(DatosPersonajesUsuario.posesionArm);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(Armas.class
